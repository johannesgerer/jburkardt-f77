...
c*********************************************************************72
c
cc C4_COS evaluates the cosine of a C4 argument.
c
c  Licensing:
c
...
c
c    Output, complex C4_COS, the cosine of Z.
c
      implicit none
...
c*********************************************************************72
c
cc C4_SIN evaluates the sine of a C4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, complex Z, the argument.
c
c    Output, complex C4_SIN, the sine of Z.
c
      implicit none
...
c*********************************************************************72
c
cc I4_MACH returns integer machine dependent constants.
c
c  Discussion:
c
c    Input/output unit numbers.
c
c      I4_MACH(1) = the standard input unit.
c      I4_MACH(2) = the standard output unit.
c      I4_MACH(3) = the standard punch unit.
c      I4_MACH(4) = the standard error message unit.
c
c    Words.
c
c      I4_MACH(5) = the number of bits per integer storage unit.
c      I4_MACH(6) = the number of characters per integer storage unit.
c
c    Integers.
c
...
c    where 0 <= X(1:S-1) < A.
c
c      I4_MACH(7) = A, the base.
c      I4_MACH(8) = S, the number of base A digits.
c      I4_MACH(9) = A**S-1, the largest integer.
c
...
c
c      I4_MACH(10) = B, the base.
c
c    Single precision
c
c      I4_MACH(11) = T, the number of base B digits.
c      I4_MACH(12) = EMIN, the smallest exponent E.
c      I4_MACH(13) = EMAX, the largest exponent E.
c
c    Double precision
c
c      I4_MACH(14) = T, the number of base B digits.
c      I4_MACH(15) = EMIN, the smallest exponent E.
c      I4_MACH(16) = EMAX, the largest exponent E.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    1 <= I <= 16.
c
c    Output, integer I4_MACH, the value of the chosen parameter.
c
      implicit none
...
c*********************************************************************72
c
cc R4_ACOS evaluates the arc-cosine of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c
c    Output, real R4_ACOS, the arc-cosine of X.
c
      implicit none
      ...
      data pi2 / 1.57079632679489661923E+00 /
...
c*********************************************************************72
c
cc R4_ACOSH evaluates the arc-hyperbolic cosine of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_ACOSH, the arc-hyperbolic cosine of X.
c
      implicit none
      ...
      if ( xmax .eq. 0.0E+00 ) then
        xmax = 1.0E+00 / sqrt ( r4_mach ( 3 ) )
      end if

      if ( x .lt. 1.0E+00 ) then
        write ( *, '(a)' ) ' '
        write ( *, '(a)' ) 'R4_ACOSH - Fatal erorr!'
        write ( *, '(a)' ) '  X < 1.' 
        stop
      end if

      if ( x .lt. xmax ) then
        value = alog ( x + sqrt ( x * x - 1.0E+00 ) )
      else
        value = aln2 + alog ( x )
      end if
...
c*********************************************************************72
c
cc R4_ADMP: modulus and phase of the derivative of the Airy function.
c
c  Description:
c
c    This function must only be called when X <= -1.0.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real AMPL, PHI, the modulus and phase of the 
c    derivative of the Airy function.
c
      implicit none
...
c*********************************************************************72
c
cc R4_AI evaluates the Airy function Ai of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_AI, the Airy function Ai of X.
c
      implicit none
      ...
      if ( naif .eq. 0 ) then
        ...
        xmax = ( - 1.5E+00 * alog ( r4_mach ( 1 ) ) )**0.6667E+00
        xmax = xmax - xmax * alog ( xmax ) 
...
c*********************************************************************72
c
cc R4_AID evaluates the derivative of the Airy function Ai of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_AID, the derivative of the Airy function Ai of X.
c
      implicit none
...
c*********************************************************************72
c
cc R4_AIDE: exponentially scaled derivative, Airy function Ai of an R4 argument.
c
c  Discussion:
c
c    if X <= 0,
c      R4_AIDE ( X ) = R4_AID ( X )
c    else
c      R4_AIDE ( X ) = R4_AID ( X ) * exp ( 2/3 * X**(3/2) )
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_AIDE, the exponentially scaled derivative of 
c    the Airy function Ai of X.
c
      implicit none
...
c*********************************************************************72
c
cc R4_AIE evaluates the exponential scaled Airy function Ai of an R4 argument.
c
c  Discussion:
c
c    If X <= 0
c      R4_AIE ( X ) = R4_AI ( X )
c    else
c      R4_AIE ( X ) = R4_AI ( X ) * exp ( 2/3 X^(3/2) )
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_AIE, the Airy function Ai of X.
c
      implicit none
...
c*********************************************************************72
c
cc R4_AIMP evaluates the modulus and phase of the Airy function.
c
c  Description:
c
c    This function must only be called when X <= -1.0.
...
c    Input, real X, the argument.
c
c    Output, real R4_AINT, the truncated version of X.
c
      implicit none
...
c*********************************************************************72
c
cc R4_ASIN evaluates the arc-sine of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_ASIN, the arc-sine of X.
c
      implicit none
     ...
     &      r4_csevl ( 3.0E+00 - 4.0E+00 * z, asincs, nterms ) )
        ...
        if ( x .lt. 0.0E+00 ) then
          value = - abs ( value )
        else if ( 0.0E+00 .lt. x ) then
          value = + abs ( value )
        end if

      else if ( x .lt. 1.0E+00 + sqeps ) then
...
c*********************************************************************72
c
cc R4_ASINH evaluates the arc-sine of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_ASINH, the arc-hyperbolic sine of X.
c
      implicit none
...
c*********************************************************************72
c
cc R4_ATAN evaluates the arc-tangent of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_ATAN, the arc-tangent of X.
c
      implicit none
     ...
     &      50.0E+00 * y * y - 1.0E+00, atancs, nterms ) )
      ...
      else if ( y .le. xbnd4 ) then

        if ( xbnd3 .lt. y ) then
          n = 3
        else if ( xbnd2 .lt. y ) then
          n = 2
        else
          n = 1
        end if
...
c*********************************************************************72
c
cc R4_ATAN2 evaluates the arc-tangent of two R4 arguments.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c  Parameters:
c
c    Input, real SN, CS, the Y and X coordinates of a point on the angle.
c
c    Output, real R4_ATAN2, the arc-tangent of the angle.
c
      implicit none
      ...
      if ( sml .eq. 0.0E+00 ) then
        sml = r4_mach ( 1 )
        big = r4_mach ( 2 )
      end if
c
c  We now make sure SN can be divided by CS.  It is painful.
c
      abssn = abs ( sn )
      abscs = abs ( cs )

      if ( abscs .le. abssn ) then

        if ( abscs .lt. 1.0E+00 .and. abscs * big .le. abssn ) then

          if ( sn .lt. 0.0E+00 ) then
            r4_atan2 = - 0.5E+00 * pi
          else if ( sn .eq. 0.0E+00 ) then
            write ( *, '(a)' ) ' '
        ...
        if ( 1.0E+00 .lt. abscs .and. abssn .le. abscs * sml ) then

          if ( 0.0E+00 .le. cs ) then
            r4_atan2 = 0.0E+00
          else
            r4_atan2 = pi
          end if
      ...
      if ( cs .lt. 0.0E+00 ) then
        r4_atan2 = r4_atan2 + pi
      end if

      if ( pi .lt. r4_atan2 ) then
...
c*********************************************************************72
c
cc R4_ATANH evaluates the arc-hyperbolic tangent of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_ATANH, the arc-hyperbolic tangent of X.
c
      implicit none
      ...
      if ( y .le. sqeps ) then
        value = x
      else if ( y .le. 0.5E+00 ) then
        value = x * ( 1.0E+00 
     &    + r4_csevl ( 8.0E+00 * x * x - 1.0E+00, atnhcs, nterms ) )
      else if ( y .lt. 1.0E+00 ) then
        value = 0.5E+00 * alog ( ( 1.0E+00 + x ) / ( 1.0E+00 - x ) )
      else
        write ( *, '(a)' ) ' '
...
c*********************************************************************72
c
cc R4_BESI0 evaluates the Bessel function I of order 0 of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_BESI0, the Bessel function I of order 0 of X.
c
      implicit none
...
c*********************************************************************72
c
cc R4_BESI0E evaluates the exponentially scaled Bessel function I0(X).
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_BESI0E, the exponentially scaled Bessel 
c    function I0(X).
c
      implicit none
...
c*********************************************************************72
c
cc R4_BESI1 evaluates the Bessel function I of order 1 of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_BESI1, the Bessel function I of order 1 of X.
c
      implicit none
...
c*********************************************************************72
c
cc R4_BESI1E: exponentially scaled Bessel function I of order 1 of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_BESI1E, the exponentially scaled Bessel function I 
c    of order 1 of X.
c
      implicit none
...
c*********************************************************************72
c
cc R4_BESJ0 evaluates the Bessel function J of order 0 of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_BESJ0, the Bessel function J of order 0 of X.
c
      implicit none
...
c*********************************************************************72
c
cc R4_BESJ1 evaluates the Bessel function J of order 1 of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_BESJ1, the Bessel function J of order 1 of X.
c
      implicit none
...
c*********************************************************************72
c
cc R4_BESK evaluates the Bessel function K of order NU of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c  Parameters:
c
c    Input, real NU, the order.
c
c    Input, real X, the argument.
c
c    Output, real R4_BESK, the Bessel function K of order NU at X.
c
      implicit none
...
c*********************************************************************72
c
cc R4_BESK0 evaluates the Bessel function K of order 0 of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_BESK0, the Bessel function K of order 0 of X.
c
      implicit none
      ...
      if ( ntk0 .eq. 0 ) then
        ...
        xsml = sqrt ( 4.0E+00 * r4_mach ( 3 ) )
        xmax = - alog ( r4_mach ( 1 ) )
        xmax = xmax - 0.5E+00 * xmax * alog ( xmax ) 
     &    / ( xmax + 0.5E+00 ) - 0.01E+00
      ...
      if ( x .le. 0.0E+00 ) then
        ...
        y = 0.0E+00
        r4_besk0 = - alog ( 0.5E+00 * x ) * r4_besi0 ( x ) 
     &    - 0.25E+00 + r4_csevl ( 0.5E+00 * y - 1.0E+00, bk0cs, ntk0 )
      else if ( x .le. 2.0E+00 ) then
        y = x * x
        r4_besk0 = - alog ( 0.5E+00 * x ) * r4_besi0 ( x ) 
     &    - 0.25E+00 + r4_csevl ( 0.5E+00 * y - 1.0E+00, bk0cs, ntk0 )
      else if ( x .le. xmax ) then
...
c*********************************************************************72
c
cc R4_BESK0E evaluates the exponentially scaled Bessel function K0(X).
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_BESK0E, the exponentially scaled Bessel 
c    function K0(X).
c
      implicit none
      ...
      if ( x .le. 0.0E+00 ) then
        ...
        y = 0.0E+00
        r4_besk0e = exp ( x ) * ( - alog ( 0.5E+00 * x ) 
     &    * r4_besi0 ( x ) - 0.25E+00 
...
c*********************************************************************72
c
cc R4_BESK1 evaluates the Bessel function K of order 1 of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_BESK1, the Bessel function K of order 1 of X.
c
      implicit none
      ...
      if ( ntk1 .eq. 0 ) then
        ...
        xmin = exp ( amax1 ( alog ( r4_mach ( 1 ) ), 
     &    - alog ( r4_mach ( 2 ) ) ) + 0.01E+00 )
        xsml = sqrt ( 4.0E+00 * r4_mach ( 3 ) )
        xmax = - alog ( r4_mach ( 1 ) )
        xmax = xmax - 0.5E+00 * xmax * alog ( xmax )
     &    / ( xmax + 0.5E+00 ) - 0.01E+00
      ...
      if ( x .le. 0.0E+00 ) then
        ...
        y = 0.0E+00
        r4_besk1 = alog ( 0.5E+00 * x ) * r4_besi1 ( x ) + ( 0.75E+00 
...
c*********************************************************************72
c
cc R4_BESK1E evaluates the exponentially scaled Bessel function K1(X).
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_BESK1E, the exponentially scaled Bessel 
c    function K1(X).
c
      implicit none
     ...
     &    - alog ( r4_mach ( 2 ) ) ) + 0.01E+00 )
      ...
      if ( x .le. 0.0E+00 ) then
        ...
        y = 0.0E+00
        r4_besk1e = exp ( x ) * ( alog ( 0.5E+00 * x ) * r4_besi1 ( x ) 
     &    + ( 0.75E+00 
     &    + r4_csevl ( 0.5E+00 * y - 1.0E+00, bk1cs, ntk1 ) ) / x )
      else if ( x .le. 2.0E+00 ) then
        y = x * x
...
c*********************************************************************72
c
cc R4_BESKES evaluates a sequence of exponentially scaled K Bessel functions at X.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c  Parameters:
c
c    Input, real XNU, the order of the first function.
c    |XNU| < 1.
c
c    Input, real X, the argument.
c
c    Input, integer NIN, the absolute value of NIN indicates the number of terms to compute.
c    If NIN < 0, successive values of NU count DOWN from XNU.
c    If NIN > 0, successive values of NU count UP from XNU.
c
c    Output, real BKE(abs(NIN)), the exponentially scaled K Bessel functions.
c
      implicit none
...
c*********************************************************************72
c
cc R4_BESKS evaluates a sequence of K Bessel functions at X.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    If NIN > 0, successive values of NU count UP from XNU.
c
c    Output, real BK(abs(NIN)), the K Bessel functions.
c
      implicit none
      ...
      if ( xmax .eq. 0.0E+00 ) then
        xmax = - alog ( r4_mach ( 1 ) )
        xmax = xmax + 0.5E+00 * alog ( 3.14E+00 * 0.5E+00 / xmax )
      end if
...
c*********************************************************************72
c
cc R4_BESY0 evaluates the Bessel function Y of order 0 of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_BESY0, the Bessel function Y of order 0 of X.
c
      implicit none
...
c*********************************************************************72
c
cc R4_BESY1 evaluates the Bessel function Y of order 1 of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_BESY1, the Bessel function Y of order 1 of X.
c
      implicit none
      ...
      if ( nty1 .eq. 0 ) then
        ...
        ntm1 = r4_inits ( bm1cs, 21, 0.1E+00 * r4_mach ( 3 ) )
        ntth1 = r4_inits ( bth1cs, 24, 0.1E+00 * r4_mach ( 3 ) )
        xmin = 1.571E+00 * exp ( amax1 ( alog ( r4_mach ( 1 ) ), 
     &    - alog ( r4_mach ( 2 ) ) ) + 0.01E+00 )
        xsml = sqrt ( 4.0E+00 * r4_mach ( 3 ) )
        xmax = 1.0E+00 / r4_mach ( 4 )
      end if
      ...
      if ( x .le. 0.0E+00 ) then
        ...
        y = 0.0E+00
        r4_besy1 = twodpi * alog ( 0.5E+00 * x ) * r4_besj1 ( x ) 
...
c*********************************************************************72
c
cc R4_BETA evaluates the beta function of R4 arguments.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c  Parameters:
c
c    Input, real A, B, the arguments.
c
c    Output, real R4_BETA, the beta function of A and B.
c
      implicit none
      ...
      if ( xmax .eq. 0.0E+00 ) then
        ...
        alnsml = alog ( r4_mach ( 1 ) )
      end if

      if ( a .le. 0.0E+00 .or. b .le. 0.0E+00 ) then
        write ( *, '(a)' ) ' '
...
c*********************************************************************72
c
cc R4_BETAI evaluates the incomplete beta ratio of R4 arguments.
c
c  Discussion:
c
...
c  Reference:
c
c    Nancy Bosten, EL Battiste,
c    Remark on Algorithm 179: 
c    Incomplete Beta Ratio,
c    Communications of the ACM,
c    Volume 17, Number 3, March 1974, pages 156-157.
c
c    Wayne Fullerton,
c    Portable Special Function Routines,
c    in Portability of Numerical Software,
...
c  Parameters:
c
c    Input, real X, the upper limit of integration.
c    0.0 <= X <= 1.0.
c
c    Input, real PIN, the first distribution parameter.
c    0.0 < PIN.
c
c    Input, real QIN, the second distribution parameter.
c    0.0 < QIN.
c
c    Output, real R4_BETAI, the incomplete beta function ratio.
c
      implicit none
      ...
      if ( x .lt. 0.0E+00 .or. 1.0E+00 .lt. x ) then
        write ( *, '(a)' ) ' '
      ...
      if ( pin .le. 0.0E+00 .or. qin .le. 0.0E+00 ) then
        write ( *, '(a)' ) ' '
        write ( *, '(a)' ) 'R4_BETAI - Fatal error!'
        write ( *, '(a)' ) '  P or Q <= 0.0.'
        stop
      ...
      if ( p .lt. q .or. 0.8E+00 .le. x ) then

        if ( 0.2E+00 .le. x ) then
          y = 1.0E+00 - y
          p = qin
          q = pin
        end if
      ...
      if ( ( p + q ) * y / ( p + 1.0E+00 ) .lt. eps ) then

        r4_betai = 0.0E+00

        xb = p * alog ( amax1 ( y, sml ) ) - alog ( p ) 
     &    - r4_lbeta ( p, q )

        if ( alnsml .lt. xb .and. y .ne. 0.0E+00 ) then
          r4_betai = exp ( xb )
        end if

        if ( y .ne. x .or. p .ne. pin ) then
...
c
      ps = q - aint ( q )
      if ( ps .eq. 0.0E+00 ) then
        ps = 1.0E+00
      end if

      xb = p * alog ( y ) - r4_lbeta ( ps, p ) - alog ( p )

      if ( xb .lt. alnsml ) then
        ...
        if ( ps .ne. 1.0E+00 ) then

          n = int ( amax1 ( alneps / alog ( y ), 4.0E+00 ) )
          do i = 1, n
...
c
c  Now evaluate the finite sum.
c
      if  ( 1.0E+00 .lt. q ) then

        xb = p * alog ( y ) + q * alog ( 1.0E+00 - y ) 
     &    - r4_lbeta ( p, q ) - alog ( q )
        ib = int ( amax1 ( xb / alnsml, 0.0E+00 ) )
        ...
        do i = 1, n
          ...
          if ( p1 .le. 1.0E+00 .and. term / eps .le. finsum ) then
            go to 10
          end if
 ...
 10     continue
      ...
      if ( r4_betai .lt. 0.0E+00 ) then
        r4_betai =  0.0E+00
      end if

      if ( 1.0E+00 .lt. r4_betai ) then
        r4_betai = 1.0E+00
      end if
...
c*********************************************************************72
c
cc R4_BI evaluates the Airy function Bi of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_BI, the Airy function Bi of X.
c
      implicit none
      ...
      if ( nbif .eq. 0 ) then
        ...
        x3sml = eta ** 0.3333E+00
        xmax = ( 1.5E+00 * alog ( r4_mach ( 2 ) ) ) ** 0.6666E+00
      end if
...
c*********************************************************************72
c
cc R4_BID evaluates the derivative of the Airy function Bi of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_BID, the derivative of the Airy function Bi of X.
c
      implicit none
...
c*********************************************************************72
c
cc R4_BIDE: exponentially scaled derivative, Airy function Bi of an R4 argument.
c
c  Discussion:
c
c    if X < 0,
c      R4_BIDE ( X ) = R4_BID ( X )
c    else
c      R4_BIDE ( X ) = R4_BID ( X ) * exp ( - 2/3 * X**(3/2) )
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_BIDE, the exponentially scaled derivative of 
c    the Airy function Bi of X.
c
      implicit none
      ...
      if ( x .le. - 1.0E+00 ) then
        call r4_admp ( x, xn, phi )
        r4_bide = xn * sin ( phi )
      else if ( 0.0E+00 .le. x .and. x .le. x32sml ) then
        x2 = 0.0E+00
        x3 = 0.0E+00
...
c*********************************************************************72
c
cc R4_BIE evaluates the exponentially scaled Airy function Bi of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_BIE, the exponentially scaled Airy function Bi of X.
c
      implicit none
     ...
     &    + x * ( 0.625E+00 + r4_csevl ( z, big2cs, nbig2 ) ) )
        ...
        sqrtx = sqrt ( x )
        z = atr / ( x * sqrtx ) + btr
        r4_bie = ( 0.625E+00 + r4_csevl ( z, bipcs, nbip ) ) 
     &    / sqrt ( sqrtx )
      else if ( x .le. xbig ) then
        sqrtx = sqrt ( x )
        z = 16.0E+00 / ( x * sqrtx ) - 1.0E+00
        r4_bie = ( 0.625E+00 + r4_csevl ( z, bip2cs, nbip2 ) ) 
     &    / sqrt ( sqrtx )
      else
        sqrtx = sqrt ( x )
        z = - 1.0E+00
...
c*********************************************************************72
c
cc R4_BINOM evaluates the binomial coefficient using R4 arithmetic.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c  Parameters:
c
c    Input, integer N, M, the arguments.
c
c    Output, real R4_BINOM, the binomial coefficient.
c
      implicit none
      ...
      if ( bilnmx .eq. 0.0E+00 ) then
        bilnmx = alog ( r4_mach ( 2 ) )
      ...
      if ( k .le. 20 .and. 
     &  real ( k ) * alog ( real ( amax0 ( n, 1 ) ) ) .le. bilnmx ) then

        r4_binom = 1.0E+00

        do i = 1, k
          r4_binom = r4_binom * real ( n - i + 1 ) / real ( i )
        end do
        ...
        r4_binom = xk * alog ( xnk / xk ) 
     &    - xn * r4_lnrel ( - ( xk - 1.0E+00 ) / xn )
     &    - 0.5E+00 * alog ( xn * xnk / xk ) + 1.0E+00 - sq2pil + corr

        if ( bilnmx .lt. r4_binom ) then
          write ( *, '(a)' ) ' '
          write ( *, '(a)' ) 'R4_BINOM - Fatal error!'
          write ( *, '(a)' ) '  Result overflows.'
          write ( *, '(a)' ) '  N or M is too big.'
...
c*********************************************************************72
c
cc R4_CBRT computes the cube root of an R4.
c
c  Discussion:
c
c    The approximation is a generalized Chebyshev series converted
c    to polynomial form.  The approximation is nearly best in the 
c    sense of relative error with 4.085 digits accuracy.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c
c    Output, real R4_CBRT, the cube root of X.
c
      implicit none
      ...
      if ( niter .eq. 0 ) then
        niter = int ( 1.443E+00 * alog ( -0.106E+00 
     &    * alog ( 0.1E+00 * r4_mach ( 3 ) ) ) + 1.0E+00 )
      end if

      value = 0.0E+00

      if ( x .ne. 0.0E+00 ) then
...
c*********************************************************************72
c
cc R4_CHI evaluates the hyperbolic cosine integral of an R4 argument.
c
c  Discussion:
c
...
c    Input, real X, the argument.
c
c    Output, real R4_CHI, the hyperbolic cosine integral
c    evaluated at X.
c
      implicit none
...
c*********************************************************************72
c
cc R4_CHU evaluates the confluent hypergeometric function of R4 arguments.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c  Parameters:
c
c    Input, real A, B, the parameters.
c
c    Input, real X, the argument.
c
c    Output, real R4_CHU, the function value.
c
      implicit none
      ...
      data pi / 3.14159265358979324E+00 /
      data eps / 0.0E+00 /
      ...
      if ( amax1 ( abs ( a ), 1.0E+00 ) 
     &  * amax1 ( abs ( 1.0E+00 + a - b ), 1.0E+00 ) 
     &  .lt. 0.99E+00 * abs ( x ) ) then
...
c
c  Consider the case b < 1.0 first.
c
      if ( n .lt. 1 ) then
...
c
      ...
      factor = r4_mop ( n ) * r4_gamr ( 1.0E+00 + a - b ) 
     &  * x ** istrt

      if ( beps .ne. 0.0E+00 ) then
...
c  the differences.
c
      if ( abs ( xtoeps - 1.0E+00 ) .le. 0.5E+00 ) then
...
c
     ...
     &      / ( xi * ( b + xi1 ) * ( a + xi1 - beps ) )
          t = c0 + xeps1 * b0
          r4_chu = r4_chu + t
          if ( abs ( t ) .lt. eps * abs ( r4_chu ) ) then
            return
          end if
        end do
...
c*********************************************************************72
c
cc R4_CHU_SCALED: scaled confluent hypergeometric function of R4 arguments.
c
c  Discussion:
c
c    Evaluate, for large z, z**a * u(a,b,z)  where U is the logarithmic
c    confluent hypergeometric function.  A rational approximation due to
c    Y L Luke is used.  When U is not in the asymptotic region, that is, when A
...
c    Input, real A, B, the parameters.
c
c    Input, real Z, the argument.
c
c    Output, real R4_CHU_SCALED, the function value.
c
      implicit none
...
c*********************************************************************72
c
cc R4_CI evaluates the cosine integral Ci of an R4 argument.
c
c  Discussion:
c
c    The cosine integral is defined by
c
c      CI(X) = - integral ( X <= T < Infinity ) ( cos ( T ) ) / T  dT
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_CI, the cosine integral Ci evaluated at X.
c
      implicit none
      ...
      if ( x .le. 0.0E+00 ) then
        ...
        y = - 1.0E+00
        r4_ci = alog ( x ) - 0.5E+00 + r4_csevl ( y, cics, nci )
...
c*********************************************************************72
c
cc R4_CIN evaluates the alternate cosine integral Cin of an R4 argument.
c
c  Discussion:
c
c    CIN(X) = gamma + log(X) 
c      + integral ( 0 <= T <= X ) ( cos ( T ) - 1 ) / T  dT
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_CIN, the cosine integral Cin evaluated at X.
c
      implicit none
     ...
     &    cincs, ncin )
        ...
        call r4_sifg ( x, f, g )
        sinx = sin ( absx )
        r4_cin = - f * sinx + g * cos ( absx ) + alog ( absx ) + eul
...
c*********************************************************************72
c
cc R4_CINH evaluates the alternate hyperbolic cosine integral Cinh of an R4 argument.
c
c  Discussion:
c
c    Cinh ( x ) = Integral ( 0 <= t <= x ) ( cosh ( t ) - 1 ) dt / t
c
c    The original text of this program had a mistake:
c      y = x * x / 9.0E+00 - 1.0E+00
c    has been corrected to
c      y = x * x / 4.5E+00 - 1.0E+00
c    JVB, 27 March 2010
c
c  Licensing:
c
...
c    Input, real X, the argument.
c
c    Output, real R4_CHI, the hyperbolic cosine integral Cinh
c    evaluated at X.
c
      implicit none
      ...
      if ( x .eq. 0.0E+00 ) then
        r4_cinh = 0.0E+00
      else if ( absx .le. xmin ) then
        r4_cinh = 0.0E+00
      else if ( x .le. xsml ) then
        y = - 1.0E+00
        r4_cinh = x * x * ( 0.25E+00 + r4_csevl ( y, cinhcs, ncinh ) )
      else if ( x .le. 3.0E+00 ) then
        y = x * x / 4.5E+00 - 1.0E+00
        r4_cinh = x * x * ( 0.25E+00 + r4_csevl ( y, cinhcs, ncinh ) )
      else
        r4_cinh = r4_chi ( absx ) - eul - alog ( absx )
      end if
...
c*********************************************************************72
c
cc R4_COS evaluates the cosine of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_COS, the cosine of X.
c
      implicit none
...
c
      data ntsn / 0 /
      data pi2 / 1.570796326794896619E+00 /
      ...
      if ( xwarn .lt. y ) then
        ...
        write ( *, '(a)' ) 'R4_COS - Warning!'
        write ( *, '(a)' ) 
     &    '  Answer < half precision because |X| is big.'
      end if
      ...
      n2 = int ( amod ( xn, 2.0E+00 ) + 0.5E+00 )
      xn = xn - 0.5E+00
      ...
      if ( r4_cos .lt. - 1.0E+00 ) then
        r4_cos = - 1.0E+00
      else if ( 1.0E+00 .lt. r4_cos ) then
        r4_cos = + 1.0E+00
      end if
...
c*********************************************************************72
c
cc R4_COS_DEG evaluates the cosine of an R4 argument in degrees.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c  Parameters:
c
c    Input, real X, the argument in degrees.
c
c    Output, real R4_COS_DEG, the cosine of X.
c
      implicit none
      ...
      data raddeg / 0.017453292519943296E+00 /

      value = cos ( raddeg * x )

      if ( amod ( x, 90.0E+00 ) .eq. 0.0E+00 ) then
...
c*********************************************************************72
c
cc R4_COSH evaluates the hyperbolic cosine of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_COSH, the hyperbolic cosine of X.
c
      implicit none
...
c*********************************************************************72
c
cc R4_COT evaluates the cotangent of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_COT, the cotangent of X.
c
      implicit none
...
c
      ...
      ifn = int ( amod ( ainty, 2.0E+00 ) )

      if ( ifn .eq. 1 ) then
        y = 1.0E+00 - y
      end if

      if ( 0.5E+00 .lt. abs ( x ) .and. y .lt. abs ( x ) * sqeps ) then
        write ( *, '(a)' ) ' '
...
c*********************************************************************72
c
cc R4_CSEVL evaluates a Chebyshev series.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c  Parameters:
c
c    Input, real X, the evaluation point.
c
c    Input, real CS(N), the Chebyshev coefficients.
c
c    Input, integer N, the number of Chebyshev coefficients.
c
c    Output, real R4_CSEVL, the Chebyshev series evaluated at X.
c
      implicit none
      ...
      if ( x .lt. -1.1E+00 .or. 1.0E+00 .lt. x ) then
        write ( *, '(a)' ) ' '
        write ( *, '(a)' ) 'R4_CSEVL - Fatal error!'
...
c*********************************************************************72
c
cc R4_DAWSON evaluates Dawson's integral of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_DAWSON, the value of Dawson's integral at X.
c
      implicit none
      ...
      if ( ntdaw .eq. 0 ) then
        ...
        xmax = exp ( amin1 ( - alog ( 2.0E+00 * r4_mach ( 1 ) ), 
     &    alog ( r4_mach ( 2 ) ) ) - 0.01E+00 )
     ...
     &    + r4_csevl ( 0.125E+00 * y * y - 1.0E+00, daw2cs, ntdaw2 ) )
        ...
        r4_dawson = ( 0.5E+00 
     &    + r4_csevl ( 32.0E+00 / y / y - 1.0E+00, dawacs, ntdawa ) ) 
     & / x
      else if ( y .le. xmax ) then
        r4_dawson = 0.5E+00 / x
      else
...
c*********************************************************************72
c
cc R4_E1 evaluates the exponential integral E1 for an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_E1, the exponential integral E1 evaluated at X.
c
      implicit none
...
c*********************************************************************72
c
cc R4_EI evaluates the exponential integral Ei for an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_EI, the exponential integral Ei evaluated at X.
c
      implicit none
...
c*********************************************************************72
c
cc R4_ERF evaluates the error function of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_ERF, the error function of X.
c
      implicit none
      ...
      if ( nterf .eq. 0 ) then
        ...
        xbig = sqrt ( - alog ( sqrtpi * r4_mach ( 3 ) ) )
...
c*********************************************************************72
c
cc R4_ERFC evaluates the co-error function of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_ERFC, the co-error function of X.
c
      implicit none
      ...
      if ( nterf .eq. 0 ) then
        ...
        xsml = - sqrt ( - alog ( sqrtpi * r4_mach ( 3 ) ) )
        xmax = sqrt ( - alog ( sqrtpi * r4_mach ( 1 ) ) )
        xmax = xmax - 0.5E+00 * alog ( xmax ) / xmax - 0.01E+00
        sqeps = sqrt ( 2.0E+00 * r4_mach ( 3 ) )
...
c*********************************************************************72
c
cc R4_EXP evaluates the exponential of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_EXP, the exponential of X.
c
      implicit none
      ...
      if ( nterms .eq. 0 ) then
        ...
        xmin = alog ( r4_mach ( 1 ) ) + 0.01E+00
        xmax = alog ( r4_mach ( 2 ) ) - 0.001E+00
      end if
     ...
     &    * r4_csevl ( f, expcs, nterms ) )
        ...
        write ( *, '(a)' ) ' '
        write ( *, '(a)' ) 'R4_EXP - Warning!'
        write ( *, '(a)' ) '  X so larger that exp(X) overflows.'
        stop
...
c*********************************************************************72
c
cc R4_EXPREL evaluates the exponential relative error term of an R4 argument.
c
c  Discussion:
c
c    The relative error term is ( exp ( x ) - 1 ) / x.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_EXPREL, the exponential relative error term
c    at X.
c
      implicit none
      ...
      if ( nterms .eq. 0 ) then
        alneps = alog ( r4_mach ( 3 ) )
        xn = 3.72E+00 - 0.3E+00 * alneps
        xln = alog ( ( xn + 1.0E+00 ) / 1.36E+00 )
     ...
     &    + 1.5E+00 )
      ...
      if ( absx .lt. xbnd ) then
        r4_exprel = 1.0E+00
      else if ( absx .le. 0.5E+00 ) then
        r4_exprel = 0.0E+00
        do i = 1, nterms
          r4_exprel = 1.0E+00 + r4_exprel * x / real ( nterms + 2 - i )
        end do
      else
...
c*********************************************************************72
c
cc R4_FAC evaluates the factorial of an I4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c
c    Output, real R4_FAC, the factorial of N.
c
      implicit none
      ...
      if ( n .lt. 0 ) then
        ...
        x = real ( n + 1 )
        r4_fac = exp ( ( x - 0.5E+00 ) * alog ( x ) - x + sq2pil 
     &    + r4_lgmc ( x ) )
...
c*********************************************************************72
c
cc R4_GAMI evaluates the incomplete gamma function for an R4 argument.
c
c  Discussion:
c
c    GAMI = Integral ( 0 <= T <= X ) exp ( - t ) * t^( a - 1 )  dt
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c  Parameters:
c
c    Input, real A, the parameter.
c
c    Input, real X, the argument.
c
c    Output, real R4_GAMI, the value of the incomplete gamma function.
c
      implicit none
      ...
      if ( x .lt. 0.0E+00 ) then
        ...
        factor = exp ( r4_lngam ( a ) + a * alog ( x ) )
...
c*********************************************************************72
c
cc R4_GAMIC evaluates the complementary incomplete gamma function.
c
c  Discussion:
c
c    GAMIC = integral ( x <= t < oo ) exp(-t) * t^(a-1) dt
c
c    GAMIC is evaluated for arbitrary real values of A and non-negative
c    values X (even though GAMIC is defined for X < 0.0), except that
c    for X = 0 and A <= 0.0, GAMIC is undefined.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c
c    Walter Gautschi,
c    A Computational Procedure for Incomplete Gamma Functions,
c    ACM Transactions on Mathematical Software,
c    Volume 5, Number 4, December 1979, pages 466-481.
c
c  Parameters:
c
c    Input, real A, the parameter.
...
c    Input, real X, the evaluation point.
c
c    Output, real R4_GAMIC, the value of the incomplete gamma function.
c
      implicit none
      ...
      if ( x .eq. 0.0E+00 ) then
        ...
        r4_gamic = exp ( r4_lngam ( a + 1.0E+00 ) - alog ( a ) )

        return
      end if

      alx = alog ( x )
      if ( a .lt. 0.0E+00 ) then
        sga = - 1.0E+00
      else
        sga = + 1.0E+00
      end if
      ...
      if ( x .lt. 1.0E+00 ) then
        ...
        if ( a .le. 0.5E+00 .and. abs ( aeps ) .le. 0.001E+00 ) then

          fm = - real ( ma )

          if ( fm .le. 1.0E+00 ) then
            e = 2.0E+00
          else
        ...
        if ( gstar .eq. 0.0E+00 ) then
          izero = 1
        else
          alngs = alog ( abs ( gstar ) )
          sgngs = sign ( 1.0E+00, gstar )
        end if
      ...
      sgng = sign ( 1.0E+00, h ) * sga * sgngam
...
c*********************************************************************72
c
cc R4_GAMIT evaluates Tricomi's incomplete gamma function for an R4 argument.
c
c  Discussion:
c
c      GAMIT = x^(-a) / gamma(a) 
c        * Integral ( 0 <= t <= x ) exp(-t) * t^(a-1) dt
c
c    with analytic continuation for a <= 0.0.  Gamma(x) is the complete
...
c    Input, real X, the argument.
c
c    Output, real R4_GAMIT, the function value.
c
      implicit none
      ...
      if ( x .eq. 0.0E+00 ) then
        if ( 0.0E+00 .lt. ainta .or. aeps .ne. 0.0E+00 ) then
      ...
      if ( x .le. 1.0E+00 ) then
        if ( - 0.5E+00 .le. a .or. aeps .ne. 0.0E+00 ) then
          call r4_lgams ( a + 1.0E+00, algap1, sgngam )
        end if
...
c
c  Evaluate in terms of alog(r4_gamic(a,x))
c
      h = 1.0E+00

      if ( aeps .ne. 0.0E+00 .or. 0.0E+00 .lt. ainta ) then
...
c*********************************************************************72
c
cc R4_GAML evaluates bounds for an R4 argument of the gamma function.
c
c  Discussion:
c
...
c  Parameters:
c
c    Output, real XMIN, XMAX, the bounds.
c
      implicit none
     ...
     &    - 0.2258E+00 + alnsml ) / ( xmin * xln + 0.5E+00 )
        ...
        if ( abs ( xmin - xold ) .lt. 0.005E+00 ) then

          xmin = - xmin + 0.01E+00

          alnbig = alog ( r4_mach ( 2 ) )
          xmax = alnbig
     ...
     &        + 0.9189E+00 - alnbig ) / ( xmax * xln - 0.5E+00 )
            ...
            if ( abs ( xmax - xold ) .lt. 0.005E+00 ) then
              xmax = xmax - 0.01E+00
              xmin = amax1 ( xmin, - xmax + 1.0E+00 )
              return
            end if
...
c*********************************************************************72
c
cc R4_GAMMA evaluates the gamma function of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_GAMMA, the gamma function of X.
c
      implicit none
     ...
     &    - alog ( r4_mach ( 2 ) ) ) + 0.01E+00 )
      ...
      if ( y .le. 10.0E+00 ) then
        ...
        y = x - real ( n )
        n = n - 1
        r4_gamma = 0.9375E+00 + r4_csevl ( 2.0E+00 * y - 1.0E+00, 
     &    gcs, ngcs )
     ...
     &      x + real ( n - 2 ) .eq. 0.0E+00 ) then
          ...
          if ( x .lt. - 0.5E+00 .and. 
     &      abs ( ( x - aint ( x - 0.5E+00 ) ) / x ) .lt. dxrel ) then
            write ( *, '(a)' ) ' '
...
c
        ...
        r4_gamma = exp ( ( y - 0.5E+00 ) * alog ( y ) - y + sq2pil 
     &    + r4_lgmc ( y ) )
        ...
        if ( abs ( ( x - aint ( x - 0.5E+00 ) ) / x ) .lt. dxrel ) then
          write ( *, '(a)' ) ' '
          write ( *, '(a)' ) 'R4_GAMMA - Warning!'
          write ( *, '(a)' ) '  X too near a negative integer,'
          write ( *, '(a)' ) '  answer is half precision.'
...
c*********************************************************************72
c
cc R4_GAMR evaluates the reciprocal gamma function of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_GAMR, the value of the reciprocal gamma
c    function at X.
c
      implicit none
      ...
      if ( x .le. 0.0E+00 .and. aint ( x ) .eq. x ) then

        r4_gamr = 0.0E+00
        
      else if ( abs ( x ) .le. 10.0E+00 ) then
...
c*********************************************************************72
c
cc R4_GMIC: complementary incomplete gamma, small X, A near negative integer.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Input, real ALX, the logarithm of X.
c
c    Output, real R4_GMIC, the complementary incomplete 
c    gamma function.
c
      implicit none
      ...
      do k = 1, 200
        ...
        t = te / fkp1
        s = s + t
        if ( abs ( t ) .lt. eps * s ) then
          go to 10
        end if
      end do

      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'R4_GMIC - Fatal eror!'
...
10    continue
 ...
 20   continue
      ...
      do k = 1, m
        r4_gmic = r4_gmic + 1.0E+00 / real ( k )
      end do
      ...
      alng = alog ( r4_gmic ) - r4_lngam ( fm + 1.0E+00 )
      ...
      if ( s .ne. 0.0E+00 ) then
        r4_gmic = r4_gmic 
     &    + sign ( exp ( - fm * alx + alog ( abs ( s ) / fm ) ), s )
      end if
...
c*********************************************************************72
c
cc R4_GMIT: Tricomi's incomplete gamma function for small X.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Input, real ALGAP1, the logarithm of Gamma ( A + 1 ).
c
c    Input, real SGNGAM, the sign of Gamma ( A + 1 ).
c
c    Input, real ALX, the logarithm of X.
c
c    Output, real R4_GMIT, the Tricomi incomplete gamma function.
c
      implicit none
 ...
 10   continue
      ...
      if ( - 0.5E+00 .le. a ) then
        algs = - algap1 + alog ( s )
        r4_gmit = exp ( algs )
        return
      end if

      algs = - r4_lngam ( 1.0E+00 + aeps ) + alog ( s )
      s = 1.0E+00
      m = - ma - 1
      t = 1.0E+00
...
20    continue
      ...
      r4_gmit = 0.0E+00
      algs = - real ( ma ) * alog ( x ) + algs

      if ( s .eq. 0.0E+00 .or. aeps .eq. 0.0E+00 ) then
        r4_gmit = exp ( algs )
        return
      end if

      sgng2 = sgngam * sign ( 1.0E+00, s )
...
c*********************************************************************72
c
cc R4_INITS initializes a Chebyshev series.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc R4_INT returns the integer part of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_INT, the integer part of X.
c
      implicit none
      ...
      if ( npart .eq. 0 ) then
        ibase = i4_mach ( 10 )
        xmax = 1.0E+00 / r4_mach ( 4 )
        xbig = amin1 ( real ( i4_mach ( 9 ) ), xmax )
        scale = ibase ** int ( alog ( xbig ) 
     &    / alog ( real ( ibase ) ) - 0.5E+00 )
        npart = alog ( xmax ) / alog ( scale ) + 1.0E+00
      end if
...
c*********************************************************************72
c
cc R4_KNUS computes a sequence of K Bessel functions.
c
c  Discussion:
c
...
c  Parameters:
c
c    Input, real XNU, the order parameter.
c
c    Input, real X, the argument.
c
c    Output, real BKNU, BKNU1, the two K Bessel functions.
c
...
c
      ...
      if ( ntc0k .eq. 0 ) then
        ...
        alnsml = alog ( r4_mach ( 1 ) )
        alnbig = alog ( r4_mach ( 2 ) )
        alneps = alog ( 0.1E+00 * r4_mach ( 3 ) )
      end if

      if ( xnu .lt. 0.0E+00 .or. 1.0E+00 .le. xnu ) then
        write ( *, '(a)' ) ' '
...
c  order (+nu).
c
      if ( x .le. 2.0E+00 ) then

        if ( 0.5E+00 .lt. xnu ) then
          v = 1.0E+00 - xnu
        else
          v = xnu
        end if
...
c
        alnz = 2.0E+00 * ( alog ( x ) - aln2 )

        if ( x .le. xnu ) then

          if ( alnbig .lt. 
     &      - 0.5E+00 * xnu * alnz - aln2 - alog ( xnu ) ) then
            write ( *, '(a)' ) ' '
            write ( *, '(a)' ) 'R4_KNUS - Fatal error!'
        ...
        if ( 0.5E+00 .lt. ztov .and. xnusml .lt. v ) then
          c0 = - 0.75E+00 
     &      + r4_csevl ( ( 8.0E+00 * v ) * v - 1.0E+00, c0kcs, ntc0k )
        end if

        if ( ztov .le. 0.5E+00 ) then
          alpha(1) = ( a0 - ztov * b0 ) / v
        else
          alpha(1) = c0 - alnz * ( 0.75E+00 +
     &      r4_csevl ( vlnz / 0.35E+00 + 1.0E+00, znu1cs, ntznu1 ) 
     &      ) * b0
        end if
        ...
        nterms = max1 ( 2.0E+00, 11.0E+00 
     &    + ( 8.0E+00 * alnz - 25.19E+00 - alneps ) 
     &    / ( 4.28E+00 - alnz ) )
        ...
        do i = 2, nterms
          ...
          a0 = a0 / ( xi * ( xi - v) )
          b0 = b0 / ( xi * ( xi + v) )
          alpha(i) = ( alpha(i-1) + 2.0E+00 * xi * a0 ) 
     &      / ( xi * ( xi + v ) )
        ...
        if ( alnbig .lt. - 0.5E+00 * ( xnu + 1.0E+00 ) * alnz 
     &    - 2.0E+00 * aln2 ) then
          iswtch = 1
          return
        end if
...
c
        ...
        nterms = min0 ( 15, max1 ( 3.0E+00, an + bn * alneps ) )

        do inu = 1, 2

          if ( inu .eq. 1 ) then
            if ( xnusml .lt. xnu ) then
              xmu = ( 4.0E+00 * xnu ) * xnu
            else
              xmu = 0.0E+00
            end if
     ...
     &        / ( a(2) * a(3) )
            ...
            do i = 4, nterms
              ...
              qq = 16.0E+00 * x2n / a(i)
              p1 = - x2n * ( real ( 12 * n * n - 20 * n ) 
     &          - a(1) ) / ( ( x2n - 2.0E+00 ) * a(i) ) - qq * x
              p2 = ( real ( 12 * n * n - 28 * n + 8 ) - a(1) ) 
     &          / a(i) - qq * x
...
c*********************************************************************72
c
cc R4_LBETA evaluates the logarithm of the beta function of R4 arguments.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real A, B, the arguments.
c
c    Output, real R4_LBETA, the logarithm of the beta function of A
c    and B.
c
      implicit none
      ...
      else if ( p .lt. 10.0E+00 .and. q .le. 10.0E+00 ) then

        r4_lbeta = alog ( r4_gamma ( p ) 
     &    * ( r4_gamma ( q ) / r4_gamma ( p + q ) ) )

      else if ( p .lt. 10.0E+00 ) then

        corr = r4_lgmc ( q ) - r4_lgmc ( p + q )

        r4_lbeta = r4_lngam ( p ) + corr + p - p * alog ( p + q ) +
     &    ( q - 0.5E+00 ) * r4_lnrel ( - p / ( p + q ) )
        ...
        r4_lbeta = - 0.5E+00 * alog ( q ) + sq2pil + corr 
     &    + ( p - 0.5E+00 ) * alog ( p / ( p + q ) ) 
     &    + q * r4_lnrel ( - p / ( p + q ) )
...
c*********************************************************************72
c
cc R4_LGAMS evaluates the log of |gamma(x)| and sign, for an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real ALGAM, the logarithm of the absolute value of
c    gamma ( X ).
c
c    Output, real SGNGAM, the sign (+1 or -1 ) of gamma ( X ).
c
      implicit none
      ...
      if ( x .le. 0.0E+00 ) then
        ...
        k = int ( amod ( - aint ( x ), 2.0E+00 ) + 0.1E+00 )
...
c*********************************************************************72
c
cc R4_LGIC evaluates the log complementary incomplete gamma function for large X.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real ALX, the logarithm of X.
c
c    Output, real R4_LGIC, the log complementary incomplete gamma function.
c
      implicit none
     ...
     &    * ( xpa + 2.0E+00 * fk ) + t )
        p = r * p
        s = s + p
        if ( abs ( p ) .lt. eps * s ) then
          r4_lgic = a * alx - x + alog ( s / xpa )
          return
        end if
      end do
...
c*********************************************************************72
c
cc R4_LGIT evaluates the log of Tricomi's incomplete gamma function.
c
c  Discussion:
c
c    Perron's continued fraction is used for large X and X <= A.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Input, real ALGAP1, the logarithm of A+1.
c
c    Output, real R4_LGIT, the log of Tricomi's incomplete
c    gamma function.
c
      implicit none
...
c*********************************************************************72
c
cc R4_LGMC evaluates the log gamma correction factor for an R4 argument.
c
c  Discussion:
c
...
c    Input, real X, the argument.
c
c    Output, real R4_LGMC, the correction factor.
c
      implicit none
      ...
      if ( nalgm .eq. 0 ) then
        ...
        xmax = exp ( amin1 ( alog ( r4_mach ( 2 ) / 12.0E+00 ), 
     &    - alog ( 12.0E+00 * r4_mach ( 1 ) ) ) )
      end if

      if ( x .lt. 10.0E+00 ) then
...
c*********************************************************************72
c
cc R4_LI evaluates the logarithmic integral for an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_LI, the logarithmic integral evaluated at X.
c
      implicit none
      ...
      if ( x .eq. 1.0E+00 ) then
        write ( *, '(a)' ) ' '
        write ( *, '(a)' ) 'R4_LI - Fatal error!'
        write ( *, '(a)' ) '  Function undefined for X = 1.'
      end if

      if ( abs ( 1.0E+00 - x ) .lt. sqeps ) then
        write ( *, '(a)' ) ' '
...
c*********************************************************************72
c
cc R4_LNGAM evaluates the log of the absolute value of gamma of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_LNGAM, the logarithm of the absolute value of
c    the gamma function of X.
c
      implicit none
      ...
      if ( 0.0E+00 .lt. x ) then
        r4_lngam = sq2pil + ( x - 0.5E+00 ) * alog ( x ) - x 
     &    + r4_lgmc ( y )
        return
      end if
      ...
      r4_lngam = sqpi2l + ( x - 0.5E+00 ) * alog ( y ) - x 
     &  - alog ( sinpiy ) - r4_lgmc ( y )

      if ( abs ( ( x - aint ( x - 0.5E+00 ) ) * r4_lngam / x ) 
     &  .lt. dxrel ) then
        write ( *, '(a)' ) ' '
...
c*********************************************************************72
c
cc R4_LNREL evaluates log ( 1 + X ) for an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_LNREL, the value of LOG ( 1 + X ).
c
      implicit none
      ...
      if ( abs ( x ) .le. 0.375E+00 ) then
        r4_lnrel = x * ( 1.0E+00 
     &    - x * r4_csevl ( x / 0.375E+00, alnrcs, nlnrel ) )
      else
        r4_lnrel = alog ( 1.0E+00 + x )
      end if
      return
      end
      function r4_log ( x )
...
c*********************************************************************72
c
cc R4_LOG evaluates the logarithm of an R4.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the evaluation point.
c
c    Output, real R4_LOG, the logarithm of X.
c
      implicit none
      ...
      xn = real ( n - 1 )
      y = 2.0E+00 * y
      ntrval = 4.0E+00 * y - 2.5E+00

      if ( ntrval .eq. 5 ) then
        t = ( ( y - 1.0E+00 ) - 1.0E+00 ) / ( y + 2.0E+00 )
      else if ( ntrval .lt. 5 ) then
        t = ( y - center(ntrval) ) / ( y + center(ntrval) )
      end if

      t2 = t * t

      r4_log = 0.625E+00 * xn + ( aln2 * xn + alncen(ntrval) 
     &  + 2.0E+00 * t 
...
c*********************************************************************72
c
cc R4_LOG10 evaluates the logarithm, base 10, of an R4.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the evaluation point.
c
c    Output, real R4_LOG10, the logarithm, base 10, of X.
c
      implicit none
...
c*********************************************************************72
c
cc R4_MACH returns single precision real machine constants.
c
c  Discussion:
c
...
c    R4_MACH will return the following values:
c
c      R4_MACH(1) = B**(EMIN-1), the smallest positive magnitude.
c      R4_MACH(2) = B**EMAX*(1-B**(-T)), the largest magnitude.
c      R4_MACH(3) = B**(-T), the smallest relative spacing.
c      R4_MACH(4) = B**(1-T), the largest relative spacing.
c      R4_MACH(5) = log10(B)
c
c  Licensing:
c
...
c    1 <= I <= 5.
c
c    Output, real R4_MACH, the value of the chosen parameter.
c
      implicit none
...
c
c    Moreven Gentleman, Scott Marovich,
c    Communications of the ACM,
...
c*********************************************************************72
c
cc R4_PAK packs a base 2 exponent into an R4.
c
c  Discussion:
c
c    This routine is almost the inverse of R4_UPAK.  It is not exactly 
c    the inverse, because abs ( x ) need not be between 0.5 and 1.0.  
c    If both R4_PAK and 2.0^n were known to be in range, we could compute
c    R4_PAK = x * 2.0^n .
c
c  Licensing:
c
...
c  Parameters:
c
c    Input, real Y, the mantissa.
c
c    Input, integer N, the exponent.
c
c    Output, real R4_PAK, the packed value.
c
      implicit none
      ...
      if ( nmin .eq. 0 ) then
        aln2b = 1.0E+00
        if ( i4_mach ( 10 ) .ne. 2 ) then
          aln2b = r4_mach ( 5 ) * aln210
        end if
        nmin = aln2b * real ( i4_mach ( 12 ) )
        nmax = aln2b * real ( i4_mach ( 13 ) )
      end if
...
c*********************************************************************72
c
cc R4_POCH evaluates Pochhammer's function of R4 arguments.
c
c  Discussion:
c
c    POCH ( A, X ) = Gamma ( A + X ) / Gamma ( A ).
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c  Parameters:
c
c    Input, real A, X, the arguments.
c
c    Output, real R4_POCH, the Pochhammer function of A and X.
c
      implicit none
      ...
      data pi / 3.141592653589793238E+00 /
      data eps / 0.0E+00 /
      data sqeps / 0.0E+00 /
      ...
      if ( ax .le. 0.0E+00 .and. aint ( ax ) .eq. ax ) then

        if ( 0.0E+00 .lt. a .or. aint ( a ) .ne. a ) then
          write ( *, '(a)' ) ' '
...
c
        if ( x .eq. 0.0E+00 ) then
          r4_poch = 1.0E+00
        else if ( - 20.0E+00 .le. amin1 ( a + x, a ) ) then
          n = int ( x )
...
c
      if ( a .le. 0.0E+00 .and. aint ( a ) .eq. a ) then
        r4_poch = 0.0E+00
        return
      end if
...
c
      if ( real ( n ) .eq. x .and. n .le. 20 ) then
        r4_poch = 1.0E+00
        do i = 1, n
          r4_poch = r4_poch * ( a + real ( i - 1 ) )
        end do
        return
      end if
      ...
      if ( amax1 ( absax, absa ) .le. 20.0E+00 ) then
        r4_poch = r4_gamma ( a + x ) * r4_gamr ( a )
        return
      end if

      if ( 0.5E+00 * absa .lt. abs ( x ) ) then
...
c
     ...
     &  + x * alog ( b + x ) - x + r4_lgmc ( b + x ) - r4_lgmc ( b ) )

      if ( 0.0E+00 .le. a .or. r4_poch .eq. 0.0E+00 ) then
        return
      end if
...
c*********************************************************************72
c
cc R4_POCH1 evaluates a quantity related to Pochhammer's symbol.
c
c  Discussion:
c
...
c    Input, real X, the evaluation point.
c
c    Output, real R4_POCH1, the value of the function.
c
      implicit none
      ...
      if ( 0.1E+00 * absa .lt. absx .or. 
     &  0.1E+00 .lt. absx * alog ( amax1 ( absa, 2.0E+00 ) ) ) then
      ...
      if ( var .lt. sqtbig ) then
        ...
        do k = 2, nterms
          ...
          gbern(k+1) = - rho * gbk / real ( k )
          term = term * ( real ( 2 * k - 2 ) - x ) 
     &      * ( real ( 2 * k - 1 ) - x ) * var2
...
c
      ...
      trig = sinpxx * r4_cot ( pi * b ) 
     &  - 2.0E+00 * sinpx2 * ( sinpx2 / x )
...
c*********************************************************************72
c
cc R4_POW computes a power of an R4.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c  Parameters:
c
c    Input, real X, the base.
c
c    Input, real Y, the power.
c
c    Output, real R4_POW, the value of X^Y.
c
      implicit none
...
c*********************************************************************72
c
cc R4_PSI evaluates the psi function of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_PSI, the psi function of X.
c
      implicit none
      ...
      if ( y .lt. 2.0E+00 ) then
        ...
        if ( x .lt. 0.0E+00 .and. x + real ( n - 2 ) .eq. 0.0E+00 ) then
          write ( *, '(a)' ) ' '
          write ( *, '(a)' ) 'R4_PSI - Fatal error!'
          write ( *, '(a)' ) '  X is a negative integer.'
          stop
     ...
     &    abs ( ( x - aint ( x - 0.5E+00 ) ) / x ) .lt. dxrel ) then
        ...
        do i = 1, n
          r4_psi = r4_psi - 1.0E+00 / ( x + real ( i - 1 ) )
        end do
        ...
        if ( x .lt. 0.0E+00 ) then
          ...
          r4_psi = alog ( abs ( x ) ) - 0.5E+00 / x + aux 
     &      - pi * r4_cot ( pi * x )

        else if ( 0.0E+00 .lt. x ) then

          r4_psi = alog ( x ) - 0.5E+00 / x + aux
...
c*********************************************************************72
c
cc R4_RAND is a portable pseudorandom number generator.
c
c  Discussion:
c
c    This pseudo-random number generator is portable amoung a wide
c    variety of computers.  It is undoubtedly not as good as many
...
c    method described by Knuth in seminumerical methods (p.9),
...
c
c    The first four random numbers should be 
c
c      0.0004127026,
c      0.6750836372, 
c      0.1614754200, 
c      0.9086198807.
c
c    The tenth random number is 
c
c      0.5527787209.
c
c    The hundredth random number is 
c
c      0.3600893021.  
c
c    The thousandth number should be 
c
c      0.2176990509.
c
...
c  Parameters:
c
c    Input, real R, determines the action.
c    * R = 0.0, the next random number of the sequence is generated.
c    * R < 0.0, the last generated number will be returned for
c    possible use in a restart procedure.
c    * R > 0.0, the sequence of random numbers will start with the
c    seed ( R mod 1 ).  This seed is also returned as the value of
c    R4_RAND provided the arithmetic is done exactly.
c
c    Output, real R4_RAND, a pseudo-random number between 0.0 and 1.0.
c
      implicit none
      ...
      if ( 0.0 .lt. r ) then
        ix1 = int ( amod ( r, 1.0E+00 ) * 4194304.0E+00 + 0.5E+00 )
        ix0 = mod ( ix1, 2048 )
        ix1 = ( ix1 - ix0 ) / 2048
      end if

      r4_rand = real ( ix1 * 2048 + ix0 )
...
c*********************************************************************72
c
cc R4_RANDGS generates a normally distributed random number.
c
c  Discussion:
c
c    This function generate a normally distributed random number, that is, 
c    it generates random numbers with a Gaussian distribution.  These 
c    random numbers are not exceptionally good, especially in the tails 
c    of the distribution, but this implementation is simple and suitable 
...
c  Parameters:
c
c    Input, real XMEAN, the mean of the Gaussian distribution.
c
c    Input, real SD, the standard deviation of the Gaussian function.
c
c    Output, real R4_RANDGS, a normally distributed random number.
c
      implicit none
...
c*********************************************************************72
c
cc R4_RANDOM is a portable pseudorandom number generator.
c
c  Discussion:
c
...
c
c    The motivation for using this scheme, which resembles the
c    Maclaren-Marsaglia method, is to greatly increase the period of the
c    random sequence.  If the period of the basic generator is P,
c    then the expected mean period of the sequence generated by this
c    generator is given by
c
c      new mean P = sqrt ( pi * factorial ( N ) / ( 8 * P ) ),
c
c    where factorial ( N ) must be much greater than P in this 
c    asymptotic formula.  Generally, N should be 16 to maybe 32.
c
c  Modified:
c
c    21 March 2010
...
c  Reference:
c
c    Carter Bays, Stephen Durham,
c    Improving a Poor Random Number Generator,
c    ACM Transactions on Mathematical Software,
c    Volume 2, Number 1, March 1976, pages 59-64.
c
c  Parameters:
c
c    Input, integer N.  The absolute value of N is the number of random 
c    numbers in an auxiliary table.  Note though that iabs(N)+1 is the 
c    number of items in array T.  If N is positive and differs from its 
c    value in the previous invocation, then the table is initialized for 
c    the new value of N.  If N is negative, iabs(N) is the number of items 
c    in an auxiliary table, but the tables are now assumed already to
c    be initialized.  This option enables the user to save the table T at 
c    the end of a long computer run and to restart with the same sequence.  
c    Normally, this function would be called at most once with negative N.  
c    Subsequent invocations would have N positive and of the correct magnitude.
c
c    Input/output, real T(iabs(N)+1), an array of random numbers from 
c    a previous invocation of this function.  Whenever N is positive 
c    and differs from the old N, the table is initialized.  The first 
c    iabs(N) numbers are the table discussed in the reference, and the 
c    last value is Y.  This array may be saved in order to restart a sequence.
c
c    Output, R4_RANDOM, a random number between 0.0 and 1.0.
c
      implicit none
...
c*********************************************************************72
c
cc R4_RANF is a driver for R4_RANDOM.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c  Parameters:
c
c    Input, real SW, chooses the action.
c    0.0 <= SW, compute and return the next random number.
c    0.0 > SW, print the internal table, and return the current (old)
c    random number.
c
c    Output, real R4_RANF, the random value.
c
      implicit none
      ...
      if ( 0.0E+00 .le. sw .or. ranold == 0.0E+00 ) then
...
c*********************************************************************72
c
cc R4_REN is a simple random number generator.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c  Parameters:
c
c    Output, real R4_REN, the random value.
c
      implicit none
...
c*********************************************************************72
c
cc R4_SHI evaluates the hyperbolic sine integral Shi of an R4 argument.
c
c  Discussion:
c
c    Shi ( x ) = Integral ( 0 <= t <= x ) sinh ( t ) dt / t
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_SHI, the hyperbolic sine integral Shi evaluated at X.
c
      implicit none
      ...
      if ( absx .le. xsml ) then
        r4_shi = x
      else if ( absx .le. 0.375E+00 ) then
        r4_shi = x * ( 1.0E+00 
...
c*********************************************************************72
c
cc R4_SI evaluates the sine integral Si of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_SI, the sine integral Si evaluated at X.
c
      implicit none
      ...
      data nsi / 0 /
      data pi2 / 1.5707963267948966E+00 /
      data xsml / 0.0E+00 /
...
c*********************************************************************72
c
cc R4_SIFG is a utility routine.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c
      ...
      if ( nf1 .eq. 0 ) then
        ...
        xmaxf = exp ( amin1 ( - alog ( r4_mach ( 1 ) ), 
     &    alog ( r4_mach ( 2 ) ) ) - 0.01E+00 )
        xmaxg = 1.0E+00 / sqrt ( r4_mach ( 1 ) )
        xbnd = sqrt ( 50.0E+00 )
      end if

      if ( x .lt. 4.0E+00 ) then
        write ( *, '(a)' ) ' '
...
c*********************************************************************72
c
cc R4_SIN evaluates the sine of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_SIN, the sine of X.
c
      implicit none
...
c
     ...
     &    '  Answer < half precision because |X| is big.'
      ...
      if ( sgn .lt. 0.0E+00 ) then
        r4_sin = - r4_sin
      end if

      if ( r4_sin .lt. - 1.0E+00 ) then
        r4_sin = - 1.0E+00
      else if ( 1.0E+00 .lt. r4_sin ) then
        r4_sin = 1.0E+00
      end if
...
c*********************************************************************72
c
cc R4_SIN_DEG evaluates the sine of an R4 argument in degrees.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument in degrees.
c
c    Output, real R4_SIN_DEG, the sine of X.
c
      implicit none
...
c*********************************************************************72
c
cc R4_SINH evaluates the hyperbolic sine of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_SINH, the hyperbolic sine of X.
c
      implicit none
...
c*********************************************************************72
c
cc R4_SPENCE evaluates a form of Spence's function for an R4 argument.
c
c  Discussion:
c
c    This function evaluates a form of Spence's function defined by
c
c      f(x) = Integral ( 0 <= y <= x ) - log ( abs ( 1 - y ) ) / y dy
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Handbook of Mathematical Functions, page 1004,
...
c
c    K Mitchell,
c    Tables of the function Integral ( 0 < y < x ) - log | 1 - y | dy / y
c    with an account of some properties of this and related functions,
c    Philosophical Magazine,
c    Volume 40, pages 351-368, 1949.
c
c  Parameters:
c
c    Input, real X, the argument.
c
c    Output, real R4_SPENCE, Spence's function evaluated at X.
c
      implicit none
      ...
      if ( x .le. - xbig ) then
        ...
        aln = alog ( 1.0E+00 - x )
        r4_spence = - pi26 
     &    - 0.5E+00 * aln * ( 2.0E+00 * alog ( - x ) - aln )
     ...
     &    * alog ( - x ) - aln ) + ( 1.0E+00 + r4_csevl (
     &    4.0E+00 / ( 1.0E+00 - x ) - 1.0E+00, spencs, nspenc ) ) 
     & / ( 1.0E+00 - x )

      else if ( x .le. 0.0E+00 ) then

        r4_spence = - 0.5E+00 * alog ( 1.0E+00 - x ) 
     &    * alog ( 1.0E+00 - x ) - x * ( 1.0E+00 + r4_csevl ( 
     &    4.0E+00 * x / ( x - 1.0E+00 ) - 1.0E+00, spencs, nspenc ) ) 
     & / ( x - 1.0E+00 )

      else if ( x .le. 0.5E+00 ) then
     ...
     &    spencs, nspenc ) )
        ...
        r4_spence = pi26 - alog ( x ) * alog ( 1.0E+00 - x )
     &    - ( 1.0E+00 - x ) * ( 1.0E+00 + r4_csevl ( 4.0E+00 
     &    * ( 1.0E+00 - x ) - 1.0E+00, spencs, nspenc ) )

      else if ( x .eq. 1.0E+00 ) then

        r4_spence = pi26

      else if ( x .le. 2.0E+00 ) then

        r4_spence = pi26 - 0.5E+00 * alog ( x ) 
     &    * alog ( ( x - 1.0E+00 ) * ( x - 1.0E+00 ) / x )
     &    + ( x - 1.0E+00 ) * ( 1.0E+00 + r4_csevl ( 4.0E+00 
     &    * ( x - 1.0E+00 ) / x - 1.0E+00, spencs, nspenc ) ) / x

      else if ( x .lt. xbig ) then

        r4_spence = 2.0E+00 * pi26 - 0.5E+00 * alog ( x ) * alog ( x )
...
c*********************************************************************72
c
cc R4_SQRT computes the square root of an R4.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the number whose square root is desired.
c
c    Output, real R4_SQRT, the square root of X.
c
      implicit none
...
c*********************************************************************72
c
cc R4_TAN evaluates the tangent of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_TAN, the tangent of X.
c
      implicit none
...
c
      ...
      if ( 1.0E+00 - y .lt. abs ( x ) * sqeps ) then
        write ( *, '(a)' ) ' '
        write ( *, '(a)' ) 'R4_TAN - Warning!'
...
c*********************************************************************72
c
cc R4_TANH evaluates the hyperbolic tangent of an R4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, real X, the argument.
c
c    Output, real R4_TANH, the hyperbolic tangent of X.
c
      implicit none
...
c*********************************************************************72
c
cc R4_UPAK unpacks an R4 into a mantissa and exponent.
c
c  Discussion:
c
c    This function unpacks a floating point number x so that
c
c      x = y * 2.0^n
c
c    where
...
c  Parameters:
c
c    Input, real X, the number to be unpacked.
c
c    Output, real Y, the mantissa.
c
c    Output, integer N, the exponent.
c
      implicit none
...
c*********************************************************************72
c
cc R8_ACOS evaluates the arc-cosine of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c
c    Output, double precision R8_ACOS, the arc-cosine of X.
c
      implicit none
...
c*********************************************************************72
c
cc R8_ADMP: modulus and phase of the derivative of the Airy function.
c
c  Description:
c
c    This function must only be called when X <= -1.0.
...
c    Input, double precision X, the argument.
c
c    Output, double precision AMPL, PHI, the modulus and phase of the 
c    derivative of the Airy function.
c
      implicit none

      double precision ampl
      double precision an20cs(57)
      double precision an21cs(60)
      double precision an22cs(74)
      double precision aph0cs(53)
      double precision aph1cs(58)
      double precision aph2cs(72)
      ...
      else if ( x .lt. - 4.0D+00 ) then
        z = 128.0D+00 / x / x / x + 1.0D+00
        ampl = 0.3125D+00 + r8_csevl ( z, an20cs, nan20 )
        phi = - 0.625D+00 + r8_csevl ( z, aph0cs, naph0 )
      else if ( x .lt. - 2.0D+00 ) then
        z = ( 128.D+00 / x / x / x + 9.0D+00 ) / 7.0D+00
...
c*********************************************************************72
c
cc R8_AI evaluates the Airy function Ai of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_AI, the Airy function Ai of X.
c
      implicit none

      double precision aifcs(13)
      double precision aigcs(13)
      integer naif
      integer naig
      double precision r8_ai
      double precision r8_aie
      double precision r8_csevl
      integer r8_inits
      double precision r8_mach
      double precision theta
      double precision x
      double precision x3sml
      double precision xm
      double precision xmax
      double precision z
      ...
      if ( naif .eq. 0 ) then
        ...
        xmax = ( - 1.5D+00 * dlog ( r8_mach ( 1 ) ) ) ** 0.6667D+00
        xmax = xmax - xmax * dlog ( xmax ) / 
     &    ( 4.0D+00 * xmax * dsqrt ( xmax ) + 1.0D+00 ) - 0.01D+00
      end if

      if ( x .lt. - 1.0D+00 ) then
        call r8_aimp ( x, xm, theta )
        r8_ai = xm * dcos ( theta )
      else if ( dabs ( x ) .le. x3sml ) then
        z = 0.0D+00
     ...
     &    - x * ( 0.25D+00 + r8_csevl ( z, aigcs, naig ) ) )
        ...
        r8_ai = r8_aie ( x ) 
     &    * dexp ( - 2.0D+00 * x * dsqrt ( x ) / 3.0D+00 )
      else
        r8_ai = 0.0D+00
      end if
...
c*********************************************************************72
c
cc R8_AID evaluates the derivative of the Airy function Ai of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_AID, the derivative of the Airy function 
c    Ai of X.
c
      implicit none
      ...
      double precision r8_aide
      double precision r8_csevl
      integer r8_inits
      double precision r8_mach
      double precision x
      double precision x2
      double precision x2sml
      double precision x3
      double precision x3sml
      double precision xn
      ...
      if ( naif .eq. 0 ) then
        ...
        x3sml = r8_mach ( 3 ) ** 0.3334D+00
        x2sml = dsqrt ( r8_mach ( 3 ) )
      end if

      if ( x .lt. - 1.0D+00 ) then
        call r8_admp ( x, xn, phi )
        r8_aid = xn * dcos ( phi )
      else if ( dabs ( x ) .le. x2sml ) then
        x2 = 0.0D+00
        x3 = 0.0D+00
...
c*********************************************************************72
c
cc R8_AIDE: exponentially scaled derivative, Airy function Ai of an R8 argument.
c
c  Discussion:
c
c    if X <= 0,
c      R8_AIDE ( X ) = R8_AID ( X )
c    else
c      R8_AIDE ( X ) = R8_AID ( X ) * exp ( 2/3 * X^(3/2) )
c
c    Thanks to Aleksandra Piper for pointing out a correction involving 
c    the computation of Z in the last two cases, 02 February 2012.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_AIDE, the exponentially scaled derivative of 
c    the Airy function Ai of X.
c
      implicit none
      ...
      double precision aifcs(13)
      double precision aigcs(13)
      double precision aip1cs(57)
      double precision aip2cs(37)
      double precision eta
      integer naif
      integer naig
      integer naip1
      ...
      if ( x .lt. - 1.0D+00 ) then
        call r8_admp ( x, xn, phi )
        r8_aide = xn * dcos ( phi )
      else if ( dabs ( x ) .lt. x2sml ) then
        x2 = 0.0D+00
        x3 = 0.0D+00
        r8_aide = ( x2 * ( 0.125D+00 + r8_csevl ( x3, aifcs, naif ) ) 
     &    - r8_csevl ( x3, aigcs, naig ) ) - 0.25D+00
        if ( x32sml .lt. x ) then
          r8_aide = r8_aide * dexp ( 2.0D+00 * x * dsqrt ( x ) 
     &      / 3.0D+00 )
        end if
      else if ( dabs ( x ) .lt. x3sml ) then
        x2 = x * x
        x3 = 0.0D+00
        r8_aide = ( x2 * ( 0.125D+00 + r8_csevl ( x3, aifcs, naif ) ) 
     &    - r8_csevl ( x3, aigcs, naig ) ) - 0.25D+00
...
c*********************************************************************72
c
cc R8_AIE evaluates the exponentially scaled Airy function Ai of an R8 argument.
c
c  Discussion:
c
c    if X <= 0,
c      R8_AIE ( X ) = R8_AI ( X )
c    else
c      R8_AIE ( X ) = R8_AI ( X ) * exp ( 2/3 * X**(3/2) )
c
c    Thanks to Aleksandra Piper for pointing out a correction involving a
c    missing assignment to SQRTX, 27 January 2012.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_AIE, the exponentially scaled Airy function Ai of X.
c
      implicit none
      ...
      if ( x .lt. - 1.0D+00 ) then
        call r8_aimp ( x, xm, theta )
        r8_aie = xm * dcos ( theta )
      else if ( 0.0D+00 .le. x .and. x .le. x32sml ) then
        z = 0.0D+00
     ...
     &    - x * ( 0.25D+00 + r8_csevl ( z, aigcs, naig ) ) )
        ...
        r8_aie = 0.375D+000 + ( r8_csevl ( z, aifcs, naif ) 
     &    - x * ( 0.25D+00 + r8_csevl ( z, aigcs, naig ) ) )
        r8_aie = r8_aie * dexp ( 2.0D+00 * x * dsqrt ( x ) / 3.0D+00 )
      else if ( x .le. 1.0D+00 ) then
        z = x * x * x
        r8_aie = 0.375D+000 + ( r8_csevl ( z, aifcs, naif ) 
     &    - x * ( 0.25D+00 + r8_csevl ( z, aigcs, naig ) ) )
...
c*********************************************************************72
c
cc R8_AIMP evaluates the modulus and phase of the Airy function.
c
c  Description:
c
c    This function must only be called when X <= -1.0.
...
c
      ...
      double precision am20cs(57)
      double precision am21cs(60)
      double precision am22cs(74)
      double precision ampl
      double precision ath0cs(53)
      double precision ath1cs(58)
      double precision ath2cs(72)
      double precision eta
      integer nam20
      integer nam21
      integer nam22
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_AINT, the truncated version of X.
c
      implicit none
...
c*********************************************************************72
c
cc R8_ASIN evaluates the arc-sine of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_ASIN, the arc-sine of X.
c
      implicit none
      ...
      if ( nterms .eq. 0 ) then
        ...
        sqeps = dsqrt ( 6.0D+00 * r8_mach ( 3 ) )
      end if

      y = dabs ( x )

      if ( x .lt. - 1.0D+00 - sqeps ) then
     ...
     &      r8_csevl ( 3.0D+00 - 4.0D+00 * z, asincs, nterms ) )
      ...
      else if ( x .lt. 1.0D+00 + sqeps ) then
...
c*********************************************************************72
c
cc R8_ASINH evaluates the arc-sine of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_ASINH, the arc-hyperbolic sine of X.
c
      implicit none

      double precision aln2
      double precision asnhcs(39)
      integer nterms
     ...
     &    asnhcs, nterms ) )
      else if ( y .lt. xmax ) then
        value = dlog ( y + dsqrt ( y * y + 1.0D+00 ) )
        if ( x .lt. 0.0D+00 ) then
          value = - value
        end if
      else
...
c*********************************************************************72
c
cc R8_ATAN evaluates the arc-tangent of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_ATAN, the arc-tangent of X.
c
      implicit none

      double precision atancs(16)
      double precision conpi8(4)
      integer n
      integer nterms
      double precision pi8(4)
      ...
      double precision sqeps
      double precision t
      double precision tanp8(3)
      double precision value
      double precision x
      double precision xbig
      double precision xbnd1
      double precision xbnd2
      double precision xbnd3
      double precision xbnd4
      double precision y
...
c*********************************************************************72
c
cc R8_ATAN2 evaluates the arc-tangent of two R8 arguments.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c  Parameters:
c
c    Input, double precision SN, CS, the Y and X coordinates of a 
c    point on the angle.
c
c    Output, double precision R8_ATAN2, the arc-tangent of the angle.
c
      implicit none

      double precision abscs
      double precision abssn
...
c
      ...
      if ( abscs .le. abssn ) then
        ...
        if ( abscs .lt. 1.0D+00 .and. abscs * big .le. abssn ) then

          if ( sn .lt. 0.0D+00 ) then
            r8_atan2 = - 0.5D+00 * pi
          else if ( sn .eq. 0.0D+00 ) then
            write ( *, '(a)' ) ' '
        ...
        if ( 1.0D+00 .lt. abscs .and. abssn .le. abscs * sml ) then

          if ( 0.0D+00 .le. cs ) then
            r8_atan2 = 0.0D+00
          else
            r8_atan2 = pi
          end if
      ...
      r8_atan2 = datan ( sn / cs )

      if ( cs .lt. 0.0D+00 ) then
        r8_atan2 = r8_atan2 + pi
      end if

      if ( pi .lt. r8_atan2 ) then
...
c*********************************************************************72
c
cc R8_ATANH evaluates the arc-hyperbolic tangent of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_ATANH, the arc-hyperbolic tangent of X.
c
      implicit none

      double precision atnhcs(27)
      ...
      if ( y .le. sqeps ) then
        value = x
      else if ( y .le. 0.5D+00 ) then
        value = x * ( 1.0D+00 +
     &    r8_csevl ( 8.0D+00 * x * x - 1.0D+00, atnhcs, nterms ) )
      else if ( y .lt. 1.0D+00 ) then
        value = 0.5D+00 * dlog ( ( 1.0D+00 + x ) / ( 1.0D+00 - x ) )
        if ( 1.0D+00 - y .lt. dxrel ) then
          write ( *, '(a)' ) ' '
...
c*********************************************************************72
c
cc R8_B1MP evaluates the modulus and phase for the Bessel J1 and Y1 functions.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c  Author:
c
c    Original FORTRAN77version by Wayne Fullerton.
c    This FORTRAN77version by John Burkardt.
c
c  Reference:
c
c    Wayne Fullerton,
...
c
      ...
      double precision ampl
      double precision bm12cs(40)
      double precision bm1cs(37)
      double precision bt12cs(39)
      double precision bth1cs(44)
      double precision eta
      integer nbm1
      integer nbm12
      integer nbt12
      ...
      if ( x .lt. 4.0D+00 ) then
        ...
        z = ( 128.0D+00 / x / x - 5.0D+00 ) / 3.0D+00
        ampl = ( 0.75D+00 + r8_csevl ( z, bm1cs, nbm1 ) ) / dsqrt ( x )
        theta = x - 3.0D+00 * pi4 + r8_csevl ( z, bt12cs, nbt12 ) / x
      else
        z = 128.0D+00 / x / x - 1.0D+00
        ampl = ( 0.75D+00 + r8_csevl ( z, bm12cs, nbm12 ) ) 
     &    / dsqrt ( x )
...
c*********************************************************************72
c
cc R8_BESI0 evaluates the Bessel function I of order 0 of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_BESI0, the Bessel function I of order 0 of X.
c
      implicit none

      double precision bi0cs(18)
      integer nti0
      double precision r8_besi0
      double precision r8_besi0e
      double precision r8_csevl
      integer r8_inits
      double precision r8_mach
      double precision x
...
c*********************************************************************72
c
cc R8_BESI0E evaluates the exponentially scaled Bessel function I0(X).
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_BESI0E, the exponentially scaled Bessel 
c    function I0(X).
c
      implicit none

      double precision ai02cs(69)
      double precision ai0cs(46)
      double precision bi0cs(18)
      double precision eta
      integer ntai02
      integer ntai0
...
c*********************************************************************72
c
cc R8_BESJ1 evaluates the Bessel function J of order 1 of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_BESJ1, the Bessel function J of order 1 of X.
c
      implicit none

      double precision ampl
      double precision bj1cs(19)
      integer ntj1
...
c*********************************************************************72
c
cc R8_BESK0 evaluates the Bessel function K of order 0 of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_BESK0, the Bessel function K of order 0 of X.
c
      implicit none

      double precision bk0cs(16)
      integer ntk0
      double precision r8_besi0
      double precision r8_besk0
      double precision r8_besk0e
      double precision r8_csevl
      integer r8_inits
      double precision r8_mach
      double precision x
     ...
     &    / ( xmax + 0.5D+00 )
      ...
      if ( x .le. 0.0D+00 ) then
        ...
        y = 0.0D+00
        r8_besk0 = - dlog ( 0.5D+00 * x ) * r8_besi0 ( x )  
...
c*********************************************************************72
c
cc R8_BESK0E evaluates the exponentially scaled Bessel function K0(X).
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_BESK0E, the exponentially scaled Bessel 
c    function K0(X).
c
      implicit none

      double precision ak02cs(33)
      double precision ak0cs(38)
      double precision bk0cs(16)
      double precision eta
      integer ntak0
      integer ntak02
      ...
      if ( x .le. 0.0D+00 ) then
        ...
        y = 0.0D+00
        r8_besk0e = dexp ( x ) * ( - dlog ( 0.5D+00 * x ) 
     &    * r8_besi0 ( x ) - 0.25D+00 
...
c*********************************************************************72
c
cc R8_BESY0 evaluates the Bessel function Y of order 0 of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_BESY0, the Bessel function Y of order 0 of X.
c
      implicit none

      double precision alnhaf
      double precision ampl
      double precision by0cs(19)
      integer nty0
      double precision r8_besj0
      ...
      if ( x .le. 0.0D+00 ) then
        ...
        y = 0.0D+00
        r8_besy0 = twodpi * ( alnhaf + dlog ( x ) ) * r8_besj0 ( x ) 
     &    + 0.375D+00 
...
c*********************************************************************72
c
cc R8_BESY1 evaluates the Bessel function Y of order 1 of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_BESY1, the Bessel function Y of order 1 of X.
c
      implicit none

      double precision ampl
      double precision by1cs(20)
      integer nty1
      double precision r8_besj1
      ...
      if ( nty1 .eq. 0 ) then
        ...
        xmin = 1.571D+00 * dexp ( dmax1 ( dlog ( r8_mach ( 1 ) ), 
     &    - dlog ( r8_mach ( 2 ) ) ) + 0.01D+00 )
        xsml = dsqrt ( 4.0D+00 * r8_mach ( 3 ) )
      end if
      ...
      if ( x .le. 0.0D+00 ) then
        ...
        y = 0.0D+00
        r8_besy1 = twodpi * dlog ( 0.5D+00 * x ) * r8_besj1 ( x ) 
     &    + ( 0.5D+00 
...
c*********************************************************************72
c
cc R8_BETA evaluates the beta function of R8 arguments.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c  Parameters:
c
c    Input, double precision A, B, the arguments.
c
c    Output, double precision R8_BETA, the beta function of A and B.
c
      implicit none
...
c*********************************************************************72
c
cc R8_BETAI evaluates the incomplete beta ratio of R8 arguments.
c
c  Discussion:
c
c    The incomplete Beta function ratio is the probability that a
...
c  Parameters:
c
c    Input, double precision X, the upper limit of integration.
c    0.0 <= X <= 1.0.
c
c    Input, double precision PIN, the first distribution parameter.
c    0.0 < PIN.
c
c    Input, double precision QIN, the second distribution parameter.
c    0.0 < QIN.
c
c    Output, double precision R8_BETAI, the incomplete beta function ratio.
c
      implicit none
      ...
      if ( pin .le. 0.0D+00 .or. qin .le. 0.0D+00 ) then
        write ( *, '(a)' ) ' '
        write ( *, '(a)' ) 'R8_BETAI - Fatal error!'
        write ( *, '(a)' ) '  P or Q <= 0.0.'
        stop
      ...
      if ( p .lt. q .or. 0.8D+00 .le. x ) then

        if ( 0.2D+00 .le. x ) then
          y = 1.0D+00 - y
          p = qin
          q = pin
        end if
      ...
      if ( ( p + q ) * y / ( p + 1.0D+00 ) .lt. eps ) then
        r8_betai = 0.0D+00
        xb = p * dlog ( dmax1 ( y, sml ) ) - dlog ( p ) 
     &    - r8_lbeta ( p, q )
        if ( alnsml .lt. xb .and. y .ne. 0.0D+00 ) then
          r8_betai = dexp ( xb )
        end if
        if ( y .ne. x .or. p .ne. pin ) then
      ...
      ps = q - dint ( q )
      if ( ps .eq. 0.0D+00 ) then
        ps = 1.0D+00
      end if

      xb = p * dlog ( y ) - r8_lbeta ( ps, p ) - dlog ( p )
      ...
      if ( xb .lt. alnsml ) then
        ...
        r8_betai = dexp ( xb )
        term = r8_betai * p
        if ( ps .ne. 1.0D+00 ) then
          n = int ( dmax1 ( alneps / dlog ( y ), 4.0D+00 ) )
          do i = 1, n
            xi = dble ( i )
      ...
      if ( 1.0D+00 .lt. q ) then

        xb = p * dlog ( y ) + q * dlog ( 1.0D+00 - y ) 
     &    - r8_lbeta ( p, q ) - dlog ( q )
        ib = int ( dmax1 ( xb / alnsml, 0.0D+00 ) )
        ...
        do i = 1, n
          ...
          if ( p1 .le. 1.0D+00 .and. term / eps .le. finsum ) then
            go to 10
          end if
 ...
 10     continue
      ...
      if ( r8_betai .lt. 0.0D+00 ) then
        r8_betai =  0.0D+00
      end if

      if ( 1.0D+00 .lt. r8_betai ) then
        r8_betai = 1.0D+00
      end if
...
c*********************************************************************72
c
cc R8_BI evaluates the Airy function Bi of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_BI, the Airy function Bi of X.
c
      implicit none

      double precision bifcs(13)
      double precision bif2cs(15)
      double precision bigcs(13)
      double precision big2cs(15)
      double precision eta
      integer nbif
      integer nbif2
      integer nbig
      ...
      if ( nbif .eq. 0 ) then
        ...
        x3sml = eta ** 0.3333D+00
        xmax = ( 1.5D+00 * dlog ( r8_mach ( 2 ) ) ) ** 0.6666D+00
      end if
...
c*********************************************************************72
c
cc R8_BID evaluates the derivative of the Airy function Bi of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_BID, the derivative of the Airy function Bi of X.
c
      implicit none

      double precision bif2cs(15)
      double precision bifcs(13)
      double precision big2cs(16)
      double precision bigcs(13)
      double precision eta
      integer nbif
      integer nbif2
     ...
     &    + r8_csevl ( z, big2cs, nbig2 ) + 0.5D+00
        ...
        r8_bid = r8_bide ( x ) * dexp ( 2.0D+00 * x * dsqrt ( x ) 
     &    / 3.0D+00 )
      end if
...
c*********************************************************************72
c
cc R8_BIDE: exponentially scaled derivative, Airy function Bi of an R8 argument.
c
c  Discussion:
c
c    if X < 0,
c      R8_BIDE ( X ) = R8_BID ( X )
c    else
c      R8_BIDE ( X ) = R8_BID ( X ) * exp ( - 2/3 * X**(3/2) )
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_BIDE, the exponentially scaled derivative of 
c    the Airy function Bi of X.
c
      implicit none
      ...
      double precision big2cs(16)
      double precision bigcs(13)
      double precision bip1cs(47)
      double precision bip2cs(88)
      double precision btr
      double precision eta
      integer nbif
      integer nbif2
      integer nbig
     ...
     &      * dexp ( - 2.0D+00 * x * dsqrt ( x ) / 3.0D+00 )
        ...
        z = ( 2.0D+00 * x * x * x - 9.0D+00 ) / 7.0D+00
        r8_bide = dexp ( - 2.0D+00 * x * dsqrt ( x ) / 3.0D+00 ) 
     ...
     &    * dsqrt ( sqrtx )
        ...
        sqrtx = dsqrt ( x )
        z = 16.0D+00 / x / sqrtx - 1.0D+00
        r8_bide = ( 0.625D+00 + r8_csevl ( z, bip2cs, nbip2 ) ) 
     &    * dsqrt ( sqrtx )
      else
        sqrtx = dsqrt ( x )
        z = -1.0D+00
...
c*********************************************************************72
c
cc R8_BIE evaluates the exponentially scaled Airy function Bi of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_BIE, the exponentially scaled Airy function Bi of X.
c
      implicit none
     ...
     &      * dexp ( - 2.0D+00 * x * dsqrt ( x ) / 3.0D+00 )
        ...
        z = ( 2.0D+00 * x * x * x - 9.0D+00 ) / 7.0D+00
        r8_bie = dexp ( - 2.0D+00 * x * dsqrt ( x ) / 3.0D+00 ) 
     ...
     &    + x * ( 0.625D+00 + r8_csevl ( z, big2cs, nbig2 ) ) )
        ...
        z = atr / x / sqrtx + btr
        r8_bie = ( 0.625D+00 
     &    + r8_csevl ( z, bip1cs, nbip1 ) ) / dsqrt ( sqrtx )
      else if ( x .lt. xbig ) then
        sqrtx = dsqrt ( x )
        z = 16.0D+00 / ( x * sqrtx ) - 1.0D+00
        r8_bie = ( 0.625D+00 
     &    + r8_csevl ( z, bip2cs, nbip2 ) ) / dsqrt ( sqrtx )
      else
        sqrtx = dsqrt ( x )
        z = - 1.0D+00
        r8_bie = ( 0.625D+00 
...
c*********************************************************************72
c
cc R8_BINOM evaluates the binomial coefficient using R8 arithmetic.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, integer N, M, the arguments.
c
c    Output, double precision R8_BINOM, the binomial coefficient.
c
      implicit none

      double precision bilnmx
      double precision corr
      double precision fintmx
      integer i
      integer k
      integer m
      integer n
      ...
      double precision r8_lnrel
      double precision r8_mach
      double precision sq2pil
      double precision xk
      double precision xn
      double precision xnk
      ...
      if ( bilnmx .eq. 0.0D+00 ) then
        bilnmx = dlog ( r8_mach ( 2 ) ) - 0.0001D+00
      ...
      if ( k .le. 20 .and. 
     &  dble ( k ) * dlog ( dble ( amax0 ( n, 1 ) ) ) .le. bilnmx ) then

        r8_binom = 1.0D+00

        do i = 1, k
          r8_binom = r8_binom * dble ( n - i + 1 ) / dble ( i )
        end do
        ...
        r8_binom = xk * dlog ( xnk / xk ) 
     &    - xn * r8_lnrel ( - ( xk - 1.0D+00 ) / xn )
     &    - 0.5D+00 * dlog ( xn * xnk / xk ) + 1.0D+00 - sq2pil + corr

        if ( bilnmx .lt. r8_binom ) then
          write ( *, '(a)' ) ' '
          write ( *, '(a)' ) 'R8_BINOM - Fatal error!'
          write ( *, '(a)' ) '  Result overflows.'
          write ( *, '(a)' ) '  N or M is too big.'
      ...
      if ( r8_binom .lt. fintmx ) then
        r8_binom = dint ( r8_binom + 0.5D+00 )
      end if
...
c*********************************************************************72
c
cc R8_CBRT computes the cube root of an R8.
c
c  Discussion:
c
c    The approximation is a generalized Chebyshev series converted
...
c
c    Output, double precision R8_CBRT, the cube root of X.
c
      implicit none

      double precision cbrt2(5)
      integer irem
      integer iter
      integer ixpnt
      integer n
      ...
      if ( niter .eq. 0 ) then
        niter = int ( 1.443D+00 * dlog ( - 0.106D+00 
     &    * dlog ( 0.1D+00 * r8_mach ( 3 ) ) ) + 1.0D+00 )
      end if

      value = 0.0D+00

      if ( x .ne. 0.0D+00 ) then

        call r8_upak ( dabs ( x ), y, n )
        ixpnt = n / 3
        irem = n - 3 * ixpnt + 3
...
c*********************************************************************72
c
cc R8_CHI evaluates the hyperbolic cosine integral of an R8 argument.
c
c  Discussion:
c
c    The hyperbolic cosine integral is defined by
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_CHI, the hyperbolic cosine integral
c    evaluated at X.
c
      implicit none
...
c*********************************************************************72
c
cc R8_CHU evaluates the confluent hypergeometric function of R8 arguments.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_CHU, the function value.
c
      implicit none

      double precision a
      double precision a0
      double precision aintb
      double precision alnx
      double precision b
      double precision b0
      double precision beps
      double precision c0
      double precision eps
      double precision factor
      double precision gamri1
      double precision gamrni
      integer i
      integer istrt
      integer m
      integer n
      double precision pch1ai
      double precision pch1i
      double precision pi
      double precision pochai
      double precision r8_chu
      double precision r8_chu_scaled
      double precision r8_exprel
      double precision r8_gamma
      double precision r8_gamr
      double precision r8_mach
      double precision r8_mop
      double precision r8_poch
      double precision r8_poch1
      double precision sum
      double precision t
      double precision x
      double precision xeps1
      double precision xi
      double precision xi1
      double precision xn
      double precision xtoeps
      ...
      if ( dmax1 ( dabs ( a ), 1.0D+00 ) 
     &  * dmax1 ( dabs ( 1.0D+00 + a - b ), 1.0D+00 ) 
     &  .lt. 0.99D+00 * dabs ( x ) ) then
...
c
     ...
     &  * x ** istrt
      ...
      if ( beps .ne. 0.0D+00 ) then
        factor = factor * beps * pi / dsin ( beps * pi )
      end if
...
c
c  x^(-beps) is close to 1.0, so we must be careful in evaluating the
c  differences.
c
      if ( dabs ( xtoeps - 1.0D+00 ) .le. 0.5D+00 ) then
...
c
     ...
     &      / ( xi * ( b + xi1 ) * ( a + xi1 - beps ) )
          t = c0 + xeps1 * b0
          r8_chu = r8_chu + t
          if ( dabs ( t ) .lt. eps * dabs ( r8_chu ) ) then
            return
          end if
        end do
...
c*********************************************************************72
c
cc R8_CHU_SCALED: scaled confluent hypergeometric function of R8 arguments.
c
c  Discussion:
c
c    Evaluate, for large z, z**a * u(a,b,z)  where U is the logarithmic
...
c    Input, double precision A, B, the parameters.
c
c    Input, double precision Z, the argument.
c
c    Output, double precision R8_CHU_SCALED, the function value.
c
      implicit none
      ...
      double precision ab
      double precision anbn
      double precision b
      double precision bb(4)
      double precision bp
      double precision c2
      double precision ct1
      double precision ct2
      double precision ct3
      double precision d1z
      double precision eps
      double precision g1
      double precision g2
      double precision g3
      ...
      do i = 4, 300
        ...
        if ( dabs ( r8_chu_scaled - aa(1) / bb(1) ) .lt. 
     &    eps * dabs ( r8_chu_scaled ) ) then
          return
        end if
...
c*********************************************************************72
c
cc R8_CIN evaluates the alternate cosine integral Cin of an R8 argument.
c
c  Discussion:
c
c    CIN(X) = gamma + log(X) 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_CIN, the cosine integral Cin evaluated at X.
c
      implicit none

      double precision absx
      double precision cincs(18)
     ...
     &    ncin ) * x * x
        ...
        sinx = dsin ( absx )
        r8_cin = - f * sinx + g * dcos ( absx ) + dlog ( absx ) + eul
      end if
...
c*********************************************************************72
c
cc R8_CINH evaluates the alternate hyperbolic cosine integral Cinh of an R8 argument.
c
c  Discussion:
c
c    Cinh ( x ) = Integral ( 0 <= t <= x ) ( cosh ( t ) - 1 ) dt / t
c
c    The original text of this program had a mistake:
c      y = x * x / 9.0D+00 - 1.0D+00
c    has been corrected to
c      y = x * x / 4.5D+00 - 1.0D+00
c    JVB, 27 March 2010
c
c  Licensing:
c
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_CHI, the hyperbolic cosine integral Cinh
c    evaluated at X.
c
      implicit none

      double precision absx
      double precision cinhcs(16)
      double precision eul
      integer ncinh
      double precision r8_chi
      ...
      else if ( x .le. 3.0D+00 ) then
        y = x * x / 4.5D+00 - 1.0D+00
        r8_cinh = x * x * ( 0.25D+00 + r8_csevl ( y, cinhcs, ncinh ) )
      else
        r8_cinh = r8_chi ( absx ) - eul - dlog ( absx )
      end if
...
c*********************************************************************72
c
cc R8_COS evaluates the cosine of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_COS, the cosine of X.
c
      implicit none
      ...
      integer ntsn
      double precision pi2
      double precision pi2rec
      double precision pihi
      double precision pilo
      double precision pirec
      double precision r8_cos
      double precision r8_csevl
      integer r8_inits
      double precision r8_mach
      double precision sincs(15)
      double precision x
      double precision xmax
      double precision xn
      double precision xsml
      double precision xwarn
      double precision y
...
c
     ...
     &    '  Answer < half precision because |X| is big.'
      ...
      xn = dint ( y * pirec + 0.5D+00 )
      n2 = int ( dmod ( xn, 2.0D+00 ) + 0.5D+00 )
      xn = xn - 0.5D+00
      f = ( absx - xn * pihi ) - xn * pilo
      ...
      if ( r8_cos .lt. -1.0D+00 ) then
        r8_cos = -1.0D+00
      else if ( 1.0D+00 .lt. r8_cos ) then
        r8_cos = 1.0D+00
      end if
...
c*********************************************************************72
c
cc R8_COS_DEG evaluates the cosine of an R8 argument in degrees.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c  Parameters:
c
c    Input, double precision X, the argument in degrees.
c
c    Output, double precision R8_COS_DEG, the cosine of X.
c
      implicit none
      ...
      data raddeg / 0.017453292519943295769236907684886D+00 /

      value = dcos ( raddeg * x )

      if ( dmod ( x, 90.0D+00 ) .eq. 0.0D+00 ) then

        n = int ( dabs ( x ) / 90.0D+00 + 0.5D+00 )
        n = mod ( n, 2 )

        if ( n .eq. 1 ) then
          value = 0.0D+00
        else if ( value .lt. 0.0D+00 ) then
          value = - 1.0D+00
        else
          value = + 1.0D+00
        end if
...
c*********************************************************************72
c
cc R8_COSH evaluates the hyperbolic cosine of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_COSH, the hyperbolic cosine of X.
c
      implicit none
      ...
      if ( ymax .eq. 0.0D+00 ) then
        ymax = 1.0D+00 / dsqrt ( r8_mach ( 3 ) )
      end if
...
c*********************************************************************72
c
cc R8_COT evaluates the cotangent of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_COT, the cotangent of X.
c
      implicit none

      double precision ainty
      double precision ainty2
      double precision cotcs(15)
      integer ifn
      integer nterms
      double precision pi2rec
      double precision prodbg
...
c
      ...
      ifn = int ( dmod ( ainty, 2.0D+00 ) )

      if ( ifn .eq. 1 ) then
        y = 1.0D+00 - y
      end if

      if ( 0.5D+00 .lt. dabs ( x ) .and. 
     &  y .lt. dabs ( x ) * sqeps ) then
        write ( *, '(a)' ) ' '
...
c*********************************************************************72
c
cc R8_DAWSON evaluates Dawson's integral of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_DAWSON, the value of Dawson's integral at X.
c
      implicit none

      double precision daw2cs(45)
      double precision dawacs(75)
      double precision dawcs(21)
      double precision eps
      integer ntdaw
      integer ntdaw2
      integer ntdawa
      ...
      if ( ntdaw .eq. 0 ) then
        ...
        xsml = dsqrt ( 1.5D+00 * eps )
        xbig = dsqrt ( 0.5D+00 / eps )
        xmax = dexp ( dmin1 ( - dlog ( 2.0D+00 * r8_mach ( 1 ) ), 
     &    dlog ( r8_mach ( 2 ) ) ) - 0.01D+00 )
     ...
     &    + r8_csevl ( 0.125D+00 * y * y - 1.0D+00, daw2cs, ntdaw2 ) )
        ...
        r8_dawson = ( 0.5D+00 
     &    + r8_csevl ( 32.0D+00 / y / y - 1.0D+00, dawacs, ntdawa ) ) 
     & / x
      else if ( y .le. xmax ) then
        r8_dawson = 0.5D+00 / x
      else
...
c*********************************************************************72
c
cc R8_E1 evaluates the exponential integral E1 for an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R4_E1, the exponential integral E1 evaluated at X.
c
      implicit none

      double precision ae10cs(50)
      double precision ae11cs(60)
      double precision ae12cs(41)
      double precision ae13cs(50)
      double precision ae14cs(64)
      double precision e11cs(29)
      double precision e12cs(25)
      double precision eta
      integer ntae10
      integer ntae11
      integer ntae12
      ...
      if ( x .le. - 32.0D+00 ) then
        r8_e1 = dexp ( - x ) / x * ( 1.0D+00 
     &    + r8_csevl ( 64.0D+00 / x + 1.0D+00, ae10cs, ntae10 ) )
      else if ( x .le. - 8.0D+00 ) then
        r8_e1 = dexp ( - x ) / x * ( 1.0D+00 
     &    + r8_csevl ( ( 64.0D+00 / x + 5.0D+00 ) / 3.0D+00, ae11cs,
     &    ntae11 ) )
      else if ( x .le. - 4.0D+00 ) then
        r8_e1 = dexp ( - x ) / x * (1.0D+00 
     &    + r8_csevl ( 16.0D+00 / x + 3.0D+00, ae12cs, ntae12 ) )
        ...
        r8_e1 = - dlog ( - x ) 
     &    + r8_csevl ( ( 2.0D+00 * x + 5.0D+00 ) / 3.0D+00, e11cs, 
     &    nte11 )
        ...
        r8_e1 = ( - dlog ( dabs ( x ) ) - 0.6875D+00 + x ) 
     &    + r8_csevl ( x, e12cs, nte12 )
      else if ( x .le. 4.0D+00 ) then
        r8_e1 = dexp ( - x ) / x * ( 1.0D+00 
     &    + r8_csevl ( ( 8.0D+00 / x - 5.0D+00 ) / 3.0D+00, ae13cs, 
     &    ntae13 ) )
      else if ( x .le. xmax ) then
        r8_e1 = dexp ( - x ) / x * ( 1.0D+00 
...
c*********************************************************************72
c
cc R8_EI evaluates the exponential integral Ei for an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_EI, the exponential integral Ei evaluated at X.
c
      implicit none
...
c*********************************************************************72
c
cc R8_EXP evaluates the exponential of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_EXP, the exponential of X.
c
      implicit none

      double precision aln216
      double precision expcs(14)
      double precision f
      integer n
      integer n16
      integer ndx
      ...
      if ( nterms .eq. 0 ) then
        ...
        xmin = dlog ( r8_mach ( 1 ) ) + 0.01D+00
        xmax = dlog ( r8_mach ( 2 ) ) - 0.001D+00
      end if
...
c*********************************************************************72
c
cc R8_EXPREL evaluates the exponential relative error term of an R8 argument.
c
c  Discussion:
c
c    The relative error term is ( exp ( x ) - 1 ) / x.
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_EXPREL, the exponential relative error term
c    at X.
c
      implicit none
      ...
      if ( nterms .eq. 0 ) then
        alneps = dlog ( r8_mach ( 3 ) )
        xn = 3.72D+00 - 0.3D+00 * alneps
        xln = dlog ( ( xn + 1.0D+00 ) / 1.36D+00 )
        nterms = int ( xn - ( xn * xln + alneps ) / ( xln + 1.36D+00 ) 
     &    + 1.5D+00 )
        xbnd = r8_mach ( 3 )
      end if
      ...
      if ( absx .lt. xbnd ) then
        r8_exprel = 1.0D+00
      else if ( absx .le. 0.5D+00 ) then
        r8_exprel = 0.0D+00
        do i = 1, nterms
          r8_exprel = 1.0D+00 + r8_exprel * x / dble ( nterms + 2 - i )
        end do
      else
        r8_exprel = ( dexp ( x ) - 1.0D+00 ) / x
      end if
...
c*********************************************************************72
c
cc R8_FAC evaluates the factorial of an I4 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, integer N, the argument.
c
c    Output, double precision R8_FAC, the factorial of N.
c
      implicit none

      double precision facn(31)
      integer n
      integer nmax
      ...
      if ( n .lt. 0 ) then
        ...
        x = dble ( n + 1 )
        r8_fac = dexp ( ( x - 0.5D+00 ) * dlog ( x ) - x + sq2pil 
     &    + r8_lgmc ( x ) )
...
c*********************************************************************72
c
cc R8_GAMI evaluates the incomplete gamma function for an R8 argument.
c
c  Discussion:
c
c    GAMI = Integral ( 0 <= T <= X ) exp ( - t ) * t^( a - 1 )  dt
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_GAMI, the value of the incomplete gamma function.
c
      implicit none

      double precision a
      double precision factor
      double precision r8_gami
      ...
      if ( x .lt. 0.0D+00 ) then
        ...
        factor = dexp ( r8_lngam ( a ) + a * dlog ( x ) )
...
c*********************************************************************72
c
cc R8_GAMIC evaluates the complementary incomplete gamma function.
c
c  Discussion:
c
c    GAMIC = integral ( x <= t < oo ) exp(-t) * t^(a-1) dt
...
c    Input, double precision X, the evaluation point.
c
c    Output, double precision R8_GAMIC, the value of the incomplete 
c    gamma function.
c
      implicit none

      double precision a
      double precision aeps
      double precision ainta
      double precision algap1
      double precision alneps
      double precision alngs
      ...
      double precision r8_gmic
      double precision r8_gmit
      double precision r8_lgic
      double precision r8_lgit
      double precision r8_lngam
      double precision r8_mach
      double precision sga
      double precision sgng
      double precision sgngam
      double precision sgngs
      double precision sqeps
      double precision t
      double precision x
      ...
      if ( x .eq. 0.0D+00 ) then
        ...
        r8_gamic = dexp ( r8_lngam ( a + 1.0D+00 ) - dlog ( a ) )
      ...
      if ( x .lt. 1.0D+00 ) then
        ...
        if ( a .le. 0.5D+00 .and. dabs ( aeps ) .le. 0.001D+00 ) then

          if ( - ainta .le. 1.0D+00 ) then
            e = 2.0D+00
          else
            e = 2.0D+00 * ( - ainta + 2.0D+00 ) 
     &        / ( ainta * ainta - 1.0D+00 )
          end if

          e = e - alx * x ** ( - 0.001D+00 )

          if ( e * dabs ( aeps ) .le. eps ) then
        ...
        if ( gstar .eq. 0.0D+00 ) then
          izero = 1
        else
          alngs = dlog ( dabs ( gstar ) )
          sgngs = dsign ( 1.0D+00, gstar )
        end if

      else

        if ( a .lt. x ) then
          r8_gamic = dexp ( r8_lgic ( a, x, alx ) )
          return
        end if
      ...
      if ( izero .ne. 1 ) then
        ...
        if ( alneps .lt. t ) then
          ...
          r8_gamic = sgng * dexp ( t )
          return
        end if

        if ( - alneps .lt. t ) then
          h = 1.0D+00 - sgngs * dexp ( t )
        end if

      end if

      sgng = dsign ( 1.0D+00, h ) * sga * sgngam
...
c*********************************************************************72
c
cc R8_GAMIT evaluates Tricomi's incomplete gamma function for an R8 argument.
c
c  Discussion:
c
c      GAMIT = x^(-a) / gamma(a) 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_GAMIT, the function value.
c
      implicit none
      ...
      if ( x .eq. 0.0D+00 ) then
        if ( 0.0D+00 .lt. ainta .or. aeps .ne. 0.0D+00 ) then
      ...
      if ( x .le. 1.0D+00 ) then
        if ( - 0.5D+00 .le. a .or. aeps .ne. 0.0D+00 ) then
          call r8_lgams ( a + 1.0D+00, algap1, sgngam )
        end if
...
c
c  Evaluate in terms of dlog (r8_gamic (a, x))
c
      h = 1.0D+00

      if ( aeps .ne. 0.0D+00 .or. 0.0D+00 .lt. ainta ) then
        ...
        if ( alneps .lt. t ) then
          t = t - a * alx
          r8_gamit = - sga * sgngam * dexp ( t )
          return
        end if

        if ( - alneps .lt. t ) then
          h = 1.0D+00 - sga * sgngam * dexp ( t )
        end if
...
c*********************************************************************72
c
cc R8_GAMR evaluates the reciprocal gamma function of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_GAMR, the value of the reciprocal gamma
c    function at X.
c
      implicit none

      double precision alngx
      double precision r8_gamma
      double precision r8_gamr
      double precision sgngx
      double precision x

      if ( x .le. 0.0D+00 .and. dint ( x ) .eq. x ) then

        r8_gamr = 0.0D+00
        
      else if ( dabs ( x ) .le. 10.0D+00 ) then
...
c*********************************************************************72
c
cc R8_GMIC: complementary incomplete gamma, small X, A near negative integer.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Input, double precision ALX, the logarithm of X.
c
c    Output, double precision R8_GMIC, the complementary incomplete 
c    gamma function.
c
      implicit none
      ...
      do k = 1, 200
        ...
        t = te / fkp1
        s = s + t
        if ( dabs ( t ) .lt. eps * s ) then
          go to 10
        end if
      end do

      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'R8_GMIC - Fatal eror!'
      write ( *, '(a)' ) '  No convergence after 200 iterations.'
      stop
...
20    continue
      ...
      do k = 1, m
        r8_gmic = r8_gmic + 1.0D+00 / dble ( k )
      end do
      ...
      alng = dlog ( r8_gmic ) - r8_lngam ( fm + 1.0D+00 )

      if ( bot .lt. alng ) then
        r8_gmic = sgng * dexp ( alng )
      else
        r8_gmic = 0.0D+00
      end if
      ...
      if ( s .ne. 0.0D+00 ) then
        r8_gmic = r8_gmic 
     &    + dsign ( dexp ( - fm * alx + dlog ( dabs ( s ) / fm ) ), s )
      end if
...
c*********************************************************************72
c
cc R8_GMIT: Tricomi's incomplete gamma function for small X.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Input, double precision ALGAP1, the logarithm of Gamma ( A + 1 ).
c
c    Input, double precision SGNGAM, the sign of Gamma ( A + 1 ).
c
c    Input, double precision ALX, the logarithm of X.
c
c    Output, double precision R8_GMIT, the Tricomi incomplete gamma function.
c
      implicit none
...
10    continue
      ...
      if ( - 0.5D+00 .le. a ) then
        algs = - algap1 + dlog ( s )
        r8_gmit = dexp ( algs )
        return
      end if

      algs = - r8_lngam ( 1.0D+00 + aeps ) + dlog ( s )
      s = 1.0D+00
      m = - ma - 1
      t = 1.0D+00
      do k = 1, m
        t = x * t / ( aeps - dble ( m + 1 - k ) )
        s = s + t
        if ( dabs ( t ) .lt. eps * dabs ( s ) ) then
          go to 20
        end if
...
20    continue
      ...
      r8_gmit = 0.0D+00
      algs = - dble ( ma ) * dlog ( x ) + algs

      if ( s .eq. 0.0D+00 .or. aeps .eq. 0.0D+00 ) then
        r8_gmit = dexp ( algs )
        return
      end if

      sgng2 = sgngam * dsign ( 1.0D+00, s )
      alg2 = - x - algap1 + dlog ( dabs ( s ) )

      if ( bot .lt. alg2 ) then
        r8_gmit = sgng2 * dexp ( alg2 )
      end if

      if ( bot .lt. algs ) then
        r8_gmit = r8_gmit + dexp ( algs )
      end if
...
c*********************************************************************72
c
cc R8_INT returns the integer part of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_INT, the integer part of X.
c
      implicit none
      ...
      if ( npart .eq. 0 ) then
        ibase = i4_mach ( 10 )
        xmax = 1.0D+00 / r8_mach ( 4 )
        xbig = amin1 ( dble ( i4_mach ( 9 ) ), 1.0D+00 / r8_mach ( 4 ) )
        scale = ibase ** int ( dlog ( xbig ) 
     &    / dlog ( dble ( ibase ) ) - 0.5D+00 )
        npart = dlog ( xmax ) / dlog ( scale ) + 1.0D+00
      end if
c
c  X may be too small.
c
      if ( x .lt. - xmax ) then
...
c*********************************************************************72
c
cc R8_LBETA evaluates the logarithm of the beta function of R8 arguments.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision A, B, the arguments.
c
c    Output, double precision R8_LBETA, the logarithm of the beta function of A
c    and B.
c
      implicit none
      ...
      else if ( p .lt. 10.0D+00 .and. q .le. 10.0D+00 ) then

        r8_lbeta = dlog ( r8_gamma ( p ) 
     &    * ( r8_gamma ( q ) / r8_gamma ( p + q ) ) )

      else if ( p .lt. 10.0D+00 ) then

        corr = r8_lgmc ( q ) - r8_lgmc ( p + q )

        r8_lbeta = r8_lngam ( p ) + corr + p - p * dlog ( p + q ) +
     &    ( q - 0.5D+00 ) * r8_lnrel ( - p / ( p + q ) )
        ...
        r8_lbeta = - 0.5D+00 * dlog ( q ) + sq2pil + corr 
     &    + ( p - 0.5D+00 ) * dlog ( p / ( p + q ) ) 
     &    + q * r8_lnrel ( - p / ( p + q ) )
...
c*********************************************************************72
c
cc R8_LGAMS evaluates the log of |gamma(x)| and sign, for an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision ALGAM, the logarithm of the absolute value of
c    gamma ( X ).
c
c    Output, double precision SGNGAM, the sign (+1 or -1 ) of gamma ( X ).
c
      implicit none

      double precision algam
      integer k
      double precision r8_lngam
      double precision sgngam
      double precision x
      ...
      if ( x .le. 0.0D+00 ) then
        ...
        k = int ( dmod ( - dint ( x ), 2.0D+00 ) + 0.1D+00 )
...
c*********************************************************************72
c
cc R8_LGIC evaluates the log complementary incomplete gamma function for large X.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision ALX, the logarithm of X.
c
c    Output, double precision R8_LGIC, the log complementary incomplete 
c    gamma function.
c
      implicit none
     ...
     &    * ( xpa + 2.0D+00 * fk ) + t )
        p = r * p
        s = s + p
        if ( dabs ( p ) .lt. eps * s ) then
          r8_lgic = a * alx - x + dlog ( s / xpa )
          return
        end if
      end do
...
c*********************************************************************72
c
cc R8_LGIT evaluates the log of Tricomi's incomplete gamma function.
c
c  Discussion:
c
c    Perron's continued fraction is used for large X and X <= A.
...
c    Input, double precision X, the argument.
c
c    Input, double precision ALGAP1, the logarithm of A+1.
c
c    Output, double precision R8_LGIT, the log of Tricomi's incomplete
c    gamma function.
c
      implicit none

      double precision a
      double precision a1x
      double precision algap1
      double precision ax
      double precision eps
      double precision fk
...
c*********************************************************************72
c
cc R8_LI evaluates the logarithmic integral for an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_LI, the logarithmic integral evaluated at X.
c
      implicit none
      ...
      if ( dabs ( 1.0D+00 - x ) .lt. sqeps ) then
        write ( *, '(a)' ) ' '
...
c*********************************************************************72
c
cc R8_LNGAM evaluates the log of the absolute value of gamma of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_LNGAM, the logarithm of the absolute value of
c    the gamma function of X.
c
      implicit none
      ...
      if ( 0.0D+00 .lt. x ) then
        r8_lngam = sq2pil + ( x - 0.5D+00 ) * dlog ( x ) - x 
     &    + r8_lgmc ( y )
        return
      end if
      ...
      r8_lngam = sqpi2l + ( x - 0.5D+00 ) * dlog ( y ) - x 
     &  - dlog ( sinpiy ) - r8_lgmc ( y )

      if ( dabs ( ( x - dint ( x - 0.5D+00 ) ) * r8_lngam / x ) 
     &  .lt. dxrel ) then
        write ( *, '(a)' ) ' '
...
c*********************************************************************72
c
cc R8_LNREL evaluates log ( 1 + X ) for an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_LNREL, the value of LOG ( 1 + X ).
c
      implicit none
      ...
      if ( dabs ( x ) .le. 0.375D+00 ) then
        r8_lnrel = x * ( 1.0D+00 
     &    - x * r8_csevl ( x / 0.375D+00, alnrcs, nlnrel ) )
      else
        r8_lnrel = dlog ( 1.0D+00 + x )
      end if
...
c*********************************************************************72
c
cc R8_LOG evaluates the logarithm of an R8.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the evaluation point.
c
c    Output, double precision R8_LOG, the logarithm of X.
c
      implicit none

      double precision aln2
      double precision alncen(5)
      double precision alncs(11)
      double precision center(4)
      integer n
      integer nterms
      integer ntrval
      double precision r8_csevl
...
c*********************************************************************72
c
cc R8_LOG10 evaluates the logarithm, base 10, of an R8.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the evaluation point.
c
c    Output, double precision R8_LOG10, the logarithm, base 10, of X.
c
      implicit none

      double precision aloge
...
c    such that
c      1.0 < 1.0 + real ( IBETA, kind = 8 ) ** MACHEP, 
c    except that MACHEP is bounded below by - ( IT + 3 ).
c
c    Output, integer NEGEPS, the largest negative integer 
c    such that
c      1.0 - real ( IBETA, kind = 8 ) ** NEGEPS < 1.0, 
c    except that NEGEPS is bounded below by - ( IT + 3 ).
c
c    Output, integer IEXP, the number of bits (decimal places 
c    if IBETA = 10) reserved for the representation of the exponent (including
...
c*********************************************************************72
c
cc R8_PAK packs a base 2 exponent into an R8.
c
c  Discussion:
c
c    This routine is almost the inverse of R8_UPAK.  It is not exactly 
c    the inverse, because abs(x) need not be between 0.5 and 1.0.  
c    If both R8_PAK and 2.0**n were known to be in range, we could compute
c    R8_PAK = x * 2.0**n .
c
c  Licensing:
c
...
c  Parameters:
c
c    Input, double precision Y, the mantissa.
c
c    Input, integer N, the exponent.
c
c    Output, double precision R8_PAK, the packed value.
c
      implicit none

      double precision aln210
      double precision aln2b
      integer i4_mach
      integer n
      integer nmax
      integer nmin
      ...
      if ( nmin .eq. 0 ) then
        ...
        nmin = aln2b * dble ( i4_mach ( 15 ) )
        nmax = aln2b * dble ( i4_mach ( 16 ) )
      end if
...
c*********************************************************************72
c
cc R8_POCH evaluates Pochhammer's function of R8 arguments.
c
c  Discussion:
c
c    POCH ( A, X ) = Gamma ( A + X ) / Gamma ( A ).
...
c  Parameters:
c
c    Input, double precision A, X, the arguments.
c
c    Output, double precision R8_POCH, the Pochhammer function of A and X.
c
      implicit none

      double precision a
      double precision absa
      double precision absax
      double precision alnga
      double precision alngax
      double precision ax
      double precision b
      double precision cospia
      double precision cospix
      double precision den
      double precision eps
      double precision err
      double precision errpch
      integer i
      integer ia
      integer n
      double precision pi
      ...
      double precision r8_mop
      double precision r8_poch
      double precision sgnga
      double precision sgngax
      double precision sinpia
      double precision sinpix
      double precision sqeps
      double precision x
      ...
      if ( ax .le. 0.0D+00 .and. dint ( ax ) .eq. ax ) then

        if ( 0.0D+00 .lt. a .or. dint ( a ) .ne. a ) then
          write ( *, '(a)' ) ' '
...
c
        if ( x .eq. 0.0D+00 ) then
          r8_poch = 1.0D+00
        else if ( - 20.0D+00 .lt. dmin1 ( a + x, a ) ) then
          n = int ( x )
          ia = int ( a )
          r8_poch = r8_mop ( n ) * r8_fac ( - ia ) 
     &      / r8_fac ( - ia - n )
        else
          n = int ( x )
          r8_poch = r8_mop ( n ) * dexp ( ( a - 0.5D+00 ) 
     &      * r8_lnrel ( x / ( a - 1.0D+00 ) ) 
     &      + x * dlog ( - a + 1.0D+00 - x ) - x 
     &      + r8_lgmc ( - a + 1.0D+00 ) 
     &      - r8_lgmc ( - a - x + 1.0D+00 ) )
        end if
...
c
      if ( a .le. 0.0D+00 .and. dint ( a ) .eq. a ) then
        r8_poch = 0.0D+00
        return
      end if
...
c  x is a small non-positive integer, presummably a common case.
c
      if ( dble ( n ) .eq. x .and. n .le. 20 ) then
        r8_poch = 1.0D+00
        do i = 1, n
          r8_poch = r8_poch * ( a + dble ( i - 1 ) )
        end do
        return
      end if
      ...
      if ( dmax1 ( absax, absa ) .le. 20.0D+00 ) then
        r8_poch = r8_gamma ( a + x ) * r8_gamr ( a )
        return
      end if

      if ( 0.5D+00 * absa .lt. dabs ( x ) ) then
        call r8_lgams ( a + x, alngax, sgngax )
        call r8_lgams ( a, alnga, sgnga )
        r8_poch = sgngax * sgnga * dexp ( alngax - alnga )
        return
      end if
c
...
c
      ...
      r8_poch = dexp ( ( b - 0.5D+00 ) * r8_lnrel ( x / b ) 
     &  + x * dlog ( b + x ) - x + r8_lgmc ( b + x ) - r8_lgmc ( b ) )

      if ( 0.0D+00 .le. a .or. r8_poch .eq. 0.0D+00 ) then
        return
      end if
      ...
      errpch = dabs ( x ) * ( 1.0D+00 + dlog ( b ) )
      den = cospix + cospia * sinpix / sinpia
      err = ( dabs ( x ) * ( dabs ( sinpix ) 
     &  + dabs ( cospia * cospix / sinpia ) )
     &  + dabs ( a * sinpix ) / sinpia / sinpia ) * pi
...
c*********************************************************************72
c
cc R8_POCH1 evaluates a quantity related to Pochhammer's symbol.
c
c  Discussion:
c
c    Evaluate a generalization of Pochhammer's symbol for special
...
c    Input, double precision X, the evaluation point.
c
c    Output, double precision R8_POCH1, the value of the function.
c
      implicit none
      ...
      double precision absx
      double precision alneps
      double precision alnvar
      double precision b
      double precision bern(20)
      double precision binv
      double precision bp
      double precision gbern(21)
      double precision gbk
      integer i
      integer ii
      integer incr
      integer j
      ...
      double precision sinpxx
      double precision sinpx2
      double precision sqtbig
      double precision term
      ...
      if ( sqtbig .eq. 0.0D+00 ) then
        sqtbig = 1.0D+00 / dsqrt ( 24.0D+00 * r8_mach ( 1 ) )
        alneps = dlog ( r8_mach ( 3 ) )
      end if
      ...
      if ( 0.1D+00 * absa .lt. absx .or. 
     &  0.1D+00 .lt. absx * dlog ( dmax1 ( absa, 2.0D+00 ) ) ) then
      ...
      if ( var .lt. sqtbig ) then
        ...
        do k = 2, nterms
          ...
          gbern(k+1) = - rho * gbk / dble ( k )
          term = term * ( dble ( 2 * k - 2 ) - x )
     &      * ( dble ( 2 * k - 1 ) - x ) * var2
          poly1 = poly1 + gbern(k+1) * term
        end do
...
c
c  we have r8_poch1(b,x), but bp is small, so we use backwards recursion
c  to obtain r8_poch1(bp,x).
c
      do ii = 1, incr
        i = incr - ii
        binv = 1.0D+00 / ( bp + dble ( i ) )
...
c
c  we have r8_poch1(bp,x), but a is lt -0.5.  we therefore use a reflection
c  formula to obtain r8_poch1(a,x).
c
      sinpxx = dsin ( pi * x ) / x
      sinpx2 = dsin ( 0.5D+00 * pi * x )
      trig = sinpxx * r8_cot ( pi * b ) 
     &  - 2.0D+00 * sinpx2 * ( sinpx2 / x )
...
c*********************************************************************72
c
cc R8_POW computes a power of an R8.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c  Parameters:
c
c    Input, double precision X, the base.
c
c    Input, double precision Y, the power.
c
c    Output, double precision R8_POW, the value of X^Y.
c
      implicit none

      double precision r8_pow
      double precision value
      double precision x
      double precision y
...
c*********************************************************************72
c
cc R8_PSI evaluates the psi function of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_PSI, the psi function of X.
c
      implicit none

      double precision apsics(16)
     ...
     &      dabs ( ( x - dint ( x - 0.5D+00 ) ) / x ) .lt. dxrel ) then
          ...
          do i = 1, n
            r8_psi = r8_psi - 1.0D+00 / ( x + dble ( i - 1 ) )
          end do

        else if ( 0 .lt. n ) then

          do i = 1, n
            r8_psi = r8_psi + 1.0D+00 / ( y + dble ( i ) )
          end do
        ...
        if ( x .lt. 0.0D+00 ) then
          ...
          r8_psi = dlog ( dabs ( x ) ) - 0.5D+00 / x + aux 
     &      - pi * r8_cot ( pi * x )

        else if ( 0.0D+00 .lt. x ) then

          r8_psi = dlog ( x ) - 0.5D+00 / x + aux
...
c*********************************************************************72
c
cc R8_REN is a simple random number generator.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c  Parameters:
c
c    Output, double precision R8_REN, the random value.
c
      implicit none

      integer iy
      double precision r8_ren
...
c*********************************************************************72
c
cc R8_SHI evaluates the hyperbolic sine integral Shi of an R8 argument.
c
c  Discussion:
c
c    Shi ( x ) = Integral ( 0 <= t <= x ) sinh ( t ) dt / t
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_SHI, the hyperbolic sine integral 
c    Shi evaluated at X.
c
      implicit none
      ...
      if ( absx .le. xsml ) then
        r8_shi = x
      else if ( absx .le. 0.375D+00 ) then
        r8_shi = x * ( 1.0D+00 
     &    + r8_csevl ( 128.0D+00 * x * x / 9.0D+00 - 1.0D+00, 
     &    shics, nshi ) )
      else
...
c*********************************************************************72
c
cc R8_SIN evaluates the sine of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_SIN, the sine of X.
c
      implicit none
...
c
     ...
     &    '  Answer < half precision because |X| is big.'
      ...
      if ( r8_sin .lt. - 1.0D+00 ) then
        r8_sin = - 1.0D+00
      else if ( 1.0D+00 .lt. r8_sin ) then
        r8_sin = + 1.0D+00
      end if
...
c*********************************************************************72
c
cc R8_SIN_DEG evaluates the sine of an R8 argument in degrees.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument in degrees.
c
c    Output, double precision R8_SIN_DEG, the sine of X.
c
      implicit none
...
c*********************************************************************72
c
cc R8_SINH evaluates the hyperbolic sine of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_SINH, the hyperbolic sine of X.
c
      implicit none
...
c*********************************************************************72
c
cc R8_SPENCE evaluates a form of Spence's function for an R8 argument.
c
c  Discussion:
c
c    This function evaluates a form of Spence's function defined by
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_SPENCE, Spence's function evaluated at X.
c
      implicit none

      double precision aln
      integer nspenc
      double precision pi26
      double precision r8_csevl
      integer r8_inits
      double precision r8_mach
      double precision r8_spence
      double precision spencs(38)
      double precision x
      double precision xbig
      ...
      if ( x .le. - xbig ) then
        ...
        aln = dlog ( 1.0D+00 - x )
        r8_spence = - pi26 
     &    - 0.5D+00 * aln * ( 2.0D+00 * dlog ( - x ) - aln )
     ...
     &    * dlog ( - x ) - aln ) + ( 1.0D+00 + r8_csevl (
     &    4.0D+00 / ( 1.0D+00 - x ) - 1.0D+00, spencs, nspenc ) ) 
     & / ( 1.0D+00 - x )

      else if ( x .le. 0.0D+00 ) then

        r8_spence = - 0.5D+00 * dlog ( 1.0D+00 - x ) 
     &    * dlog ( 1.0D+00 - x ) - x * ( 1.0D+00 + r8_csevl ( 
     &    4.0D+00 * x / ( x - 1.0D+00 ) - 1.0D+00, spencs, nspenc ) ) 
     & / ( x - 1.0D+00 )

      else if ( x .le. 0.5D+00 ) then
     ...
     &    spencs, nspenc ) )
        ...
        r8_spence = pi26 - dlog ( x ) * dlog ( 1.0D+00 - x )
     &    - ( 1.0D+00 - x ) * ( 1.0D+00 + r8_csevl ( 4.0D+00 
     &    * ( 1.0D+00 - x ) - 1.0D+00, spencs, nspenc ) )

      else if ( x .eq. 1.0D+00 ) then

        r8_spence = pi26

      else if ( x .le. 2.0D+00 ) then

        r8_spence = pi26 - 0.5D+00 * dlog ( x ) 
     &    * dlog ( ( x - 1.0D+00 ) * ( x - 1.0D+00 ) / x )
     &    + ( x - 1.0D+00 ) * ( 1.0D+00 + r8_csevl ( 4.0D+00 
     &    * ( x - 1.0D+00 ) / x - 1.0D+00, spencs, nspenc ) ) / x

      else if ( x .lt. xbig ) then

        r8_spence = 2.0D+00 * pi26 - 0.5D+00 * dlog ( x ) * dlog ( x )
...
c*********************************************************************72
c
cc R8_SQRT computes the square root of an R8.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the number whose square root is desired.
c
c    Output, double precision R8_SQRT, the square root of X.
c
      implicit none
...
c*********************************************************************72
c
cc R8_TAN evaluates the tangent of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_TAN, the tangent of X.
c
      implicit none
...
c
      ...
      if ( 1.0D+00 - y .lt. dabs ( x ) * sqeps ) then
        write ( *, '(a)' ) ' '
        write ( *, '(a)' ) 'R8_TAN - Warning!'
        write ( *, '(a)' ) '  Answer < half precision.'
        write ( *, '(a)' ) '  |X| big or X near pi/2 or 3*pi/2.'
...
c*********************************************************************72
c
cc R8_TANH evaluates the hyperbolic tangent of an R8 argument.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    Input, double precision X, the argument.
c
c    Output, double precision R8_TANH, the hyperbolic tangent of X.
c
      implicit none
...
c*********************************************************************72
c
cc R8_UPAK unpacks an R8 into a mantissa and exponent.
c
c  Discussion:
c
c    This function unpacks a floating point number x so that
...
c  Parameters:
c
c    Input, double precision X, the number to be unpacked.
c
c    Output, double precision Y, the mantissa.
c
c    Output, integer N, the exponent.
c
      implicit none
