...
c*********************************************************************72
c
cc CHEB_SET sets abscissas and weights for Chebyshev quadrature.
c
c  Discussion:
c
c    The integral:
...
c
      ...
      do i = 1, n
        angle = pi * dble ( n + 1 - i ) / dble ( n + 1 )
        w(i) = pi / dble ( n + 1 ) * ( sin ( angle ) )**2
        x(i) = cos ( angle )
      end do
...
c*********************************************************************72
c
cc CHEBYSHEV3_COMPUTE computs a Gauss-Chebyshev type 3 quadrature rule.
c
c  Discussion:
c
c    The integral:
...
c
      ...
      do i = 1, n
        theta(i) = dble ( 2 * ( n + 1 - i ) - 1 ) * pi / dble ( 2 * n )
      end do
